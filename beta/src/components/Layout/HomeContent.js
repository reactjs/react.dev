...
function Header({children}) {
  return (
    <h3 className="bg-gradient-to-br dark:from-gray-5 dark:via-gray-20 dark:to-gray-30 from-gray-95 via-gray-80 to-gray-50 bg-clip-text text-transparent leading-xl text-primary dark:text-primary-dark font-medium text-5xl lg:text-6xl -mt-4 mb-7 w-full max-w-3xl lg:max-w-xl">
      {children}
    </h3>
  );
}
