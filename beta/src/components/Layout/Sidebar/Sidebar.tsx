...
export function Sidebar({isMobileOnly}: {isMobileOnly?: boolean}) {
  ...
  return (
    <aside
      className={cn(
        `lg:grow-0 lg:flex flex-col w-full pt-4 pb-8 lg:pb-0 lg:max-w-xs fixed lg:sticky bg-wash dark:bg-wash-dark z-10 top-0`,
      ...
      <nav
        ...
        className="w-full h-screen lg:h-auto grow-0 pr-0 lg:pr-5 pt-6 pb-44 lg:pb-0 lg:py-6 md:pt-4 lg:pt-4 overflow-y-scroll lg:overflow-y-auto scrolling-touch scrolling-gpu">
        {isMobileSidebar ? (
          <MobileNav />
        ) : (
