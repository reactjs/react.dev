...
function BlogCard({title, date, url, children}: BlogCardProps) {
  return (
    <Link href={url as string}>
      <div className="-mx-2.5 sm:-mx-6 my-6 p-5 sm:p-6 cursor-pointer bg-card group dark:bg-card-dark rounded-2xl text-xl text-primary dark:text-primary-dark leading-relaxed">
