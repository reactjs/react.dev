    ...
    <div className="mb-4 text-secondary" translate="no">
      <div className="flex w-full rounded-t-lg bg-gray-200 dark:bg-gray-80">
        ...
        <div className="flex px-4 text-sm">
          <div className="border-b-2 border-gray-300 text-gray-50 dark:border-gray-90 dark:text-gray-30">
            Console
          </div>
          <div className="flex px-4 py-2">
            <Box className="mr-2 bg-gray-300 dark:bg-gray-90" />
            <Box className="mr-2 hidden bg-gray-300 dark:bg-gray-90 md:block" />
            <Box className="hidden bg-gray-300 dark:bg-gray-90 md:block" />
          </div>
        </div>
      </div>
      <div
