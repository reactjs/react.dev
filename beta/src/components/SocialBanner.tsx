...
export default function SocialBanner() {
  return (
    <div className="w-full bg-gray-100 dark:bg-gray-700 sticky lg:fixed py-2 h-16 sm:h-10 sm:py-0 flex items-center justify-center flex-col sm:flex-row z-[100]">
      {bannerText}
      <ExternalLink
