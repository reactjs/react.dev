...
* You should not mutate any of the inputs that your components use for rendering. That includes props, state, and context. To update the screen, ["set" state](/learn/reacting-to-input-with-state) instead of mutating preexisting objects.
