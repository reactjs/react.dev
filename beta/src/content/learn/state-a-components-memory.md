...
To fix this code, remove the unnecessary state variable. (We will discuss about [why this didn't work](/learn/choosing-the-state-structure#avoid-redundant-state) later.)
