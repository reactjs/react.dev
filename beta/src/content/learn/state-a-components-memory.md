...
* How to add a state variable with the [`useState`](/hooks/react/useState) Hook
...
The [`useState`](/hooks/react/useState) Hook provides those two things:
...
When you call [`useState`](/hooks/react/useState), you are telling React that you want this component to remember something:
