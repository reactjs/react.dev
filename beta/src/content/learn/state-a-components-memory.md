...
To fix this code, remove the unnecessary state variable. (We will discuss about [why this didn't work](TODO:/learn/troubleshooting-state-updates#setting-state-does-not-update-variables) later.)
