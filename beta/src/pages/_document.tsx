...
if (sandpackReactVersion !== '1.11.0') {
...
// To update this:
//   1. Comment out the disableAllRuntimeStyleInjection() call in _app.js
...
--sxs { --sxs:2 sp-c-gMfcns sp-c-hfoyCM sp-c-fWymNx sp-c-dRhJti sp-c-bpmgvy sp-c-kLppIp sp-c-PJLV sp-c-fVPbOs sp-c-dyHYiL sp-c-gGbYbQ sp-c-kuvqxy sp-c-ctabmA sp-c-bNbSGz sp-c-jOWzsE sp-c-jkvvao; }
@media  {
  ...
  .sp-c-dRhJti { appearance: none; border: 0px; outline: none; display: flex; align-items: center; font-size: inherit; font-family: inherit; background-color: transparent; transition: color var(--sp-transitions-default), background var(--sp-transitions-default); cursor: pointer; color: var(--sp-colors-clickable); }
  .sp-c-dRhJti:disabled { color: var(--sp-colors-disabled); }
  .sp-c-dRhJti svg { min-width: var(--sp-space-4); width: var(--sp-space-4); height: var(--sp-space-4); }
  .sp-c-dRhJti.sp-c-gMfcns { padding: var(--sp-space-1); width: var(--sp-space-7); height: var(--sp-space-7); display: flex; }
  ...
  .sp-c-kuvqxy { padding: 0 var(--sp-space-2); height: var(--sp-layout-headerHeight); white-space: nowrap; }
  .sp-c-kuvqxy:focus { outline: none; }
  ...
  .sp-c-jOWzsE { margin: 0px; outline: none; height: 100%; }
  ...
  .sp-c-laEVxU { position: absolute; right: var(--sp-space-2); bottom: var(--sp-space-2); z-index: var(--sp-zIndices-top); width: 32px; height: 32px; border-radius: var(--sp-border-radius); }
  .sp-c-laEVxU .sp-c-bpmgvy { display: block; }
  .sp-c-laEVxU .sp-c-dRhJti { display: none; }
  .sp-c-laEVxU:hover .sp-c-dRhJti { display: block; }
  .sp-c-laEVxU:hover .sp-c-bpmgvy { display: none; }
