...
On the [next](/learn/extracting-events-out-of-effects) [pages](/learn/removing-effect-dependencies), you'll learn how to fix this code without breaking the rules. It's always worth fixing!
...
You'll learn a more general approach to this type of problem in [Extrating Events out of Effects](/learn/extracting-events-out-of-effects).
