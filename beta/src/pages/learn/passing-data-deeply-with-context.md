...
<img
  alt="Lifting state up vs prop drilling"
  src="/images/docs/sketches/s_prop-drilling.png"
/>
...
<img
  alt="Context provides data to the entire tree"
  src="/images/docs/sketches/s_providing-context.png"
/>
...
Notice this example doesn't quite work, yet! All the headers have the same size because **even though you're _using_ the context, you have not _provided_ it yet.** React doesn't know where to get it!
...
<img
  alt="Context provides data to the entire tree"
  src="/images/docs/sketches/s_lifting-v-providing.png"
/>
