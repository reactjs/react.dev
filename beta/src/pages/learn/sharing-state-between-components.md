...
<img
  alt="On the left are two components each owning their own state values. On the right, they are the children of a parent component that owns both their state values."
  src="/images/docs/sketches/s_lifting-state-up.png"
/>
...
<img
  alt="The parent component passes the state setting function to both child components."
  src="/images/docs/sketches/s_passing-functions-down.png"
/>
