...
>
> Your implementation is more robust, and so I think the next point release of webfui will delegate all the "hard work" to react.js and will only focus on the areas where it adds value (enabling purely functional UI programming in clojurescript, and some other stuff related to streamlining event handling)
