...
- #### Stateless functional components
    ...
    In idiomatic React code, most of the components you write will be stateless, composing other components. We’re introducing a new, simpler syntax for these components where you can take `props` as an argument and return the element you want to render:
    ...
    // Or with destructuring and an implicit return,:
