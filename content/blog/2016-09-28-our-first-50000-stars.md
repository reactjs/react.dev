...
> Jordan Walke:
> For the first step, I propose that we do the easiest, yet most general transformation possible. My suggestion is to map xml expressions to function call expressions.
>
> - `<x></x>` becomes `x( )`
