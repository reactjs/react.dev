...
In this release, we’re revamping our server rendering APIs to support Suspense on the server and Streaming SSR. As part of these changes, the following APIs will continue working, but with limited support for Suspense:

* `renderToString`
* `renderToStaticMarkup`

For full support of Suspense on the server, React 18 introduces new recommended streaming APIs:
