...
In React 18, you can start using Suspense for data fetching in opinionated frameworks like Relay and Hydrogen, and we expect to see support in frameworks like Next and Remix, too. Ad hoc data fetching with Suspense is technically possible, but still not recommended as a general strategy.
