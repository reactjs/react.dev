...
In React 18, you can start using Suspense for data fetching in opinionated frameworks. Relay — which was developed alongside Concurrent React — supports Suspense today, and eventually we expect frameworks like Next, Hydrogen, and Remix will support Suspense, too. Ad hoc data fetching with Suspense is technically possible, but still not recommended as a general strategy.
