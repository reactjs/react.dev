...
* **[Git-Battle-React](http://github.com/Dhroov7/git-battle-react)** A React App which uses Github API to see which of the two github users are more active in open source.
