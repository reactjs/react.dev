...
* **[generator-create-redux-app](https://github.com/jonidelv/generator-create-redux-app)** This generator add redux, emotion-js and other useful libraries and tools like react-router, in top of the most common React starter Create React App.
