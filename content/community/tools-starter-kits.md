 ...
 * **[breko-hub](https://github.com/tomatau/breko-hub)** A production ready boilerplate for universal react applications. Complete with code splitting, server render (using koa), redux, sagas, debugging, hot-reloading (live updates on the server), css-modules, scss, super fast integration tests and unit tests. There's also a big focus on clean code and smaller files.
  * **[react-go](https://github.com/bojant987/react-go)** Simple boilerplate that includes stuff most react/redux projects use, like redux-thunk, axios + redux adapter for axios, react-router, react-hot-loader, babel, eslint, style/css/sass loaders, webpack config for developement and production, prettier with husky precommit hook. The emphasis here is on having a lot of stuff that you will need while remaining simple and easily customizable.
