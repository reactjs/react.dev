...
* **[ReactQL](https://github.com/leebenson/reactql)** Universal Typescript starter kit with React + Apollo GraphQL + MobX + GraphQL Code Generator + Webpack 4 + Koa + Emotion + SASS + PostCSS + Less. Used heavily in production by dozens of start-ups. Full SSR, code splitting, gzip/Brotli compression, multi-CSS aware, universal state hydration, auto-generated GraphQL components for React, hot-code reload on both the client and server, type-safe, heavily documented, and more.
