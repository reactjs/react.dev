...
>
> Finally, if you're not building a single-page application, you can either [add React to your existing build pipeline](add-react-to-an-existing-app.md) or [use it from CDN](cdn-links.md) and [without a build step](react-without-jsx.md).
