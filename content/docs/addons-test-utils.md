...
>
> Alternatively, there is another testing utility called react-testing-library. This is a simple and small utility that helps your tests give you confidence your components are working by encouraging you to write tests that use your components as the end users use them. It also works with any test runner: [https://git.io/react-testing-library](https://git.io/react-testing-library)
