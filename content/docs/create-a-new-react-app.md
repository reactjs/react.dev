...
* A **compiler** such as [Babel](http://babeljs.io/) or [TypeScript](http://www.typescriptlang.org/). It lets you write modern JavaScript code that still works in older browsers.
