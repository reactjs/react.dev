...
- **[Parcel](https://parceljs.org/)** is a blazing fast, fast, zero configuration web application bundler that [works with React](https://parceljs.org/recipes.html#react)
