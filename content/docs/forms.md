...
[React Hook Form] (https://react-hook-form.com/) is another popular library for creating forms. It mainly makes use of uncontrolled components to reduce the amounts of re-rendering caused by user inputs.
