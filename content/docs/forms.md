...
With a controlled component, the current input's value is always driven by React state. While this means you have to type a bit more code, keeping the value in state lets you pass it to other UI elements too, or reset it from other event handlers.
