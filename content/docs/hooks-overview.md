...
You've likely performed data fetching, subscriptions, or have manually changed the DOM with React components before. We call these operations "side effects" (or "effects" for short) because they can affect other components and can't be done during rendering.
