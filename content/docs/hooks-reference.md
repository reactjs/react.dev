...
If an empty array is provided, the value will be memoized once and always returned. If no array is provided, a new value will be computed on every render.
