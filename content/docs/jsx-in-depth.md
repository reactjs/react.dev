...
This is valid JSX, and `props.children` in `MyComponent` will be the string `"Hello world!"`. HTML is unescaped, so you can generally write JSX just like you would write HTML in this way:
