...
The `render` method will be called each time an update happens, but as long as the component is on screen, only a single instance of the Clock class will be used. This lets us use additional features such as local state and lifecycle hooks.
