  ...
  return (
    <NextLink
      ...
      <span className="grid">
        ...
        <span className="block text-lg truncate group-hover:underline">
          {title}
        </span>
      </span>
    </NextLink>
