...
export function createMDXComponents({
  ...
  return {
    ...MDXComponents,
    InlineToc: () => <InlineToc toc={toc} />,
    LanguageList: (props: {progress: 'complete' | 'in-progress'}) => (
      <LanguageList {...props} languages={languages} />
    ),
    CanaryBadge: (props: {title: string}) => (
      <CanaryBadge {...props} isInToc={isInToc} />
    ),
    ExperimentalBadge: (props: {title: string}) => (
      <ExperimentalBadge {...props} isInToc={isInToc} />
    ),
  };
}
