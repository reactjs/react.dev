...
(() => {
  ...
  var Hc = Z((ht) => {
    ...
    function Zs(e, t, s, i, r) {
          ...
          case 'object':
            switch (e.$$typeof) {
              ...
              case If:
                ...
                break;
              case Kc:
                return (p = e._init), Zs(p(e._payload), t, s, i, r);
            }
        }
      if (p)
        return (
      ...
      if (Vc(e))
        for (var y = 0; y < e.length; y++)
          (i = e[y]), (a = d + zo(i, y)), (p += Zs(i, t, s, a, r));
      else if (((y = Of(e)), typeof y == 'function'))
        for (e = y.call(e), y = 0; !(i = e.next()).done; )
          (i = i.value), (a = d + zo(i, y++)), (p += Zs(i, t, s, a, r));
      else if (a === 'object') {
        if (typeof e.then == 'function') return Zs(Bf(e), t, s, i, r);
        throw (
          ((t = String(e)),
          Error(
            Yo(
    ...
    ht.cloneElement = function (e, t, s) {
      ...
      var i = Df({}, e.props),
        ...
        a = void 0;
      if (t != null)
        for (p in (t.ref !== void 0 && (a = void 0),
    ...
    ht.lazy = function (e) {
      return {$$typeof: Kc, _payload: {_status: -1, _result: e}, _init: Vf};
    };
  ...
  var zc = Z((Oi) => {
    'use strict';
    var $f = Li(),
      qf = Symbol.for('react.transitional.element'),
    ...
    function Gc(e, t, s) {
      ...
      return (
        (t = s.ref),
        {$$typeof: qf, type: e, key: i, ref: t !== void 0 ? t : null, props: s}
      );
    }
    Oi.Fragment = Kf;
    Oi.jsx = Gc;
  ...
  var Jc = Z((jn) => {
    ...
    if (!Uf.__SERVER_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE)
      throw Error(
        'The "react" package in this environment is not configured correctly. The "react-server" condition must be enabled in any environment that runs React Server Components.'
      );
    function br(e, t) {
  ...
  var Qu = Z((En) => {
    ...
    function Bi(e) {
      yu.push(e), Tu.port2.postMessage(null);
    }
    function Gf(e) {
      setTimeout(function () {
        throw e;
    ...
    var zf = Promise,
      ku =
        typeof queueMicrotask == 'function'
          ? queueMicrotask
          : function (e) {
              zf.resolve(null).then(e).catch(Gf);
            },
      ln = null,
      cn = 0;
    function Cr(e, t) {
    ...
    var Yf = Function.prototype.bind,
      Jf = Array.prototype.slice;
    function xu() {
      var e = Yf.apply(this, arguments);
      if (this.$$typeof === Ar) {
        var t = Jf.call(arguments, 1),
          s = {value: Ar},
          i = {value: this.$$id};
        return (
    ...
    var gu = {
      ...
      _u = Hf.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
      qn = _u.d;
    _u.d = {f: qn.f, r: qn.r, D: td, C: nd, L: Sr, m: bu, X: id, S: sd, M: rd};
    function td(e) {
    ...
    function ld(e, t) {
      ...
      return (s = new Proxy(s, ad)), e.set(s, t), s;
    }
    var cd = Symbol.for('react.element'),
      ...
      hd = Symbol.for('react.memo_cache_sentinel');
    ...
    var Au = {
      ...
      useMemoCache: function (e) {
        for (var t = Array(e), s = 0; s < e; s++) t[s] = hd;
        return t;
      },
    ...
    function Td(e) {
      if ((e !== null && typeof e == 'object') || typeof e == 'function') {
        if (typeof e.then == 'function') {
          var t = ta;
          return (ta += 1), ni === null && (ni = []), fd(ni, e, t);
        }
        e.$$typeof === tu && na();
      }
      throw e.$$typeof === rs
        ? e.value != null && e.value.$$typeof === tu
    ...
    function _s(e, t) {
      ...
      if (kn(e)) {
        for (var r = '[', a = 0; a < e.length; a++) {
          0 < a && (r += ', ');
          var p = e[a];
          (p = typeof p == 'object' && p !== null ? _s(p) : iu(p)),
            '' + a === t
        ...
        for (r = '{', a = Object.keys(e), p = 0; p < a.length; p++) {
          ...
          (r += ('"' + d + '"' === y ? d : y) + ': '),
            (y = e[d]),
            (y = typeof y == 'object' && y !== null ? _s(y) : iu(y)),
            d === t
  ...
  ` + r;
    ...
    function Nu(e, t, s, i, r, a, p, d, y) {
      if (Is.A !== null && Is.A !== su)
        throw Error(
      ...
      (this.type = e),
        ...
        (this.onError = i === void 0 ? kd : i),
        (this.onPostpone = r === void 0 ? Cs : r),
        (this.onAllReady = a),
        (this.onFatalError = p),
        (e = os(this, t, null, !1, 0, k)),
        A.push(e);
    }
    var st = null;
    function ru(e, t, s) {
          ...
          if (k.done)
            (y.status = 1),
              (k =
                ...
                `:C
`),
              e.completedRegularChunks.push(pn(k)),
...
`;
      ...
      function p() {
        if (d.status === 0) {
          ...
          y.removeEventListener('abort', p);
          var k = y.reason;
          e.type === 21
            ? (e.abortableTasks.delete(d), ri(d), oi(d, e))
            : (Un(e, d, y.reason), un(e)),
            typeof i.throw == 'function' && i.throw(k).then(a, a);
        }
      }
      s = s === i;
      var d = os(
...
`
    ...
    function _d(e, t, s) {
      ...
      return {$$typeof: $i, _payload: s, _init: gd};
    }
    function ou() {}
    function bd(e, t, s, i) {
      if (typeof i != 'object' || i === null || i.$$typeof === rs) return i;
      if (typeof i.then == 'function') return _d(e, t, i);
      var r = Su(i);
      return r
        ? ((e = {}),
    ...
    function ia(e, t, s, i, r, a) {
      ...
      if (s != null && typeof s == 'object' && s.$$typeof !== rs)
        ...
        typeof s == 'string' &&
          ((r = t.formatContext),
          (p = od(r, s, a)),
          r !== p && a.children != null && bs(e, a.children, p));
      return (
        (e = i),
        (i = t.keyPath),
        ...
        toJSON: function (y, k) {
          ...
          try {
            ...
            if (
              ...
              (d.status = 3),
                e.type === 21
                  ? ((A = e.nextChunkId++), (A = y ? ws(A) : Ct(A)), (f = A))
                  : ((A = e.fatalError), (f = y ? ws(A) : Ct(A)));
            else if (
              ((k = g === pa ? Iu() : g),
...
`),
    ...
    function uu(e, t, s, i) {
      var r = i.$$async ? i.$$id + '#async' : i.$$id,
        ...
        p = a.get(r);
      if (p !== void 0) return t[0] === In && s === '1' ? ws(p) : Ct(p);
      try {
        ...
        if (k) p = k.name;
          ...
          var A = y.lastIndexOf('#');
          if ((A !== -1 && ((p = y.slice(A + 1)), (k = d[y.slice(0, A)])), !k))
            throw Error(
...
`,
    ...
    function bs(e, t, s) {
      return (t = os(e, t, null, !1, s, e.abortableTasks)), Mu(e, t), t.id;
    }
    function Yt(e, t, s) {
      e.pendingChunks++;
      var i = e.nextChunkId++;
    ...
    function Cd(e, t) {
      ...
      var a = [t.type],
        p = os(e, a, null, !1, 0, e.abortableTasks),
...
- A compiler tries to "inline" JSX instead of using the runtime.`);
        ...
        if (r.$$typeof === rs) return uu(e, s, i, r);
        if (
        ...
        if (
          ...
          if (p !== void 0) {
            if (t.keyPath !== null || t.implicitSlot)
              return '$@' + ru(e, t, r).toString(16);
            if (ss === r) ss = null;
            else return p;
          }
          return (e = '$@' + ru(e, t, r).toString(16)), a.set(r, e), e;
        }
        if (p !== void 0)
          if (ss === r) {
        ...
        if (typeof Blob == 'function' && r instanceof Blob) return Cd(e, r);
        if ((a = Su(r)))
          return (
            (i = a.call(r)),
            i === r
        ...
        if (((a = r[Ss]), typeof a == 'function'))
          return (
            t.keyPath !== null
              ...
              : ((i = a.call(r)), (e = xd(e, t, r, i))),
            e
          );
        if (r instanceof Date) return '$D' + r.toJSON();
        if (((e = ii(r)), e !== yd && (e === null || ii(e) !== null)))
          throw Error(
      ...
      if (typeof r == 'string')
        return (
          ...
          r[r.length - 1] === 'Z' && s[i] instanceof Date
            ...
            ? (e.pendingChunks++, (t = e.nextChunkId++), Ou(e, t, r, !1), Ct(t))
            : ((e = r[0] === '$' ? '$' + r : r), e)
        );
...
If you need interactivity, consider converting part of this to a Client Component.`
    ...
    function Ki(e, t) {
      ...
      s(t),
        e.destination !== null
          ? ((e.status = 14), vu(e.destination, t))
...
`),
      ...
      if (t.status === 0) {
        ...
        try {
          ...
          if (
            ...
            e.writtenObjects.set(i, Ct(t.id)), Du(e, t, i);
          else {
            var r = Es(i);
            Lu(e, t.id, r);
          }
    ...
    function ra(e) {
      ...
      try {
        var i = e.pingedTasks;
        e.pingedTasks = [];
        for (var r = 0; r < i.length; r++) Mu(e, i[r]);
        ai(e);
      } catch (a) {
        Kn(e, a, null), Ki(e, a);
      } finally {
    ...
    function fa(e, t, s) {
      e.status === 3 &&
        ((s = Ct(s)), (e = Ru(t, e.id, s)), t.completedErrorChunks.push(e));
    }
    function ri(e) {
      e.status === 0 && (e.status = 3);
    }
    ...
    function Vu(e, t) {
      if (e.status === 13) (e.status = 14), vu(t, e.fatalError);
    ...
    var qu = new Map(),
      Ed = __webpack_require__.u;
    __webpack_require__.u = function (e) {
      var t = qu.get(e);
      return t !== void 0 ? t : Ed(e);
    };
    var Dr = Symbol();
    function Ot(e, t, s) {
    ...
    function Mr(e, t, s, i) {
      for (var r = 0; r < t.length; r++) {
        var a = t[r];
        typeof a == 'function' ? a(s) : Gu(e, a, s, i.reason);
      }
    }
    function da(e, t, s) {
    ...
    function Ad(e, t, s, i) {
      ...
      t.$$promise = d;
      var y = ju(e._bundlerConfig, a);
      if (((p = t.bound), (a = $u(y))))
        p instanceof Ot && (a = Promise.all([a, p]));
      else if (p instanceof Ot) a = Promise.resolve(p);
      else return (p = Fi(y)), (a = d), (a.status = 'fulfilled'), (a.value = p);
      if (Ye) {
        var k = Ye;
        k.deps++;
      } else
        k = Ye = {chunk: null, value: null, reason: null, deps: 1, errored: !1};
      return (
        a.then(function () {
          var A = Fi(y);
          if (t.bound) {
            var u = t.bound.value;
            if (((u = kn(u) ? u.slice(0) : []), 1e3 < u.length)) {
              r(
                Error(
    ...
    function oa(e, t, s, i, r, a) {
      if (typeof i == 'string') return Dd(e, t, s, i, r, a);
      if (typeof i == 'object' && i !== null)
        if (
          ...
          for (
            1 < i.length && (p.fork = !0), $n(p, i.length + 1, e), t = 0;
            t < i.length;
            t++
          )
            i[t] = oa(
      ...
      try {
        ...
        if (d !== null)
          for (e.value = null, e.reason = null, a = 0; a < d.length; a++) {
            var y = d[a];
            typeof y == 'function' ? y(p) : Gu(i, y, p, r);
          }
        if (Ye !== null) {
    ...
    function Gu(e, t, s, i) {
      var r = t.handler,
        ...
        y = t.path;
      try {
        for (var k = 0, A = e._rootArrayContexts, u = 1; u < y.length; u++) {
          var f = y[u];
          if (
            typeof s != 'object' ||
            s === null ||
          ...
          if (((s = s[f]), kn(s))) (k = 0), (i = A.get(s) || i);
          else if (((i = null), typeof s == 'string')) k = s.length;
          else if (typeof s == 'bigint') {
            var x = Math.abs(Number(s));
            k = x === 0 ? 1 : Math.floor(Math.log10(x)) + 1;
          } else k = ArrayBuffer.isView(s) ? s.byteLength : 0;
        }
        var g = d(e, s, a, p),
          S = t.arrayRoot;
        S !== null &&
          (i !== null
            ? (i.fork && (S.fork = !0), $n(S, i.count, e))
            : 0 < k && $n(S, k, e));
      } catch (E) {
        Pr(e, r, E);
        return;
    ...
    function Di(e, t, s, i, r, a) {
      ...
      switch (d.status) {
        case 'fulfilled':
          (p = d.value), (d = d.reason);
          for (var y = 0, k = e._rootArrayContexts, A = 1; A < t.length; A++) {
            if (
              ((y = t[A]),
              typeof p != 'object' ||
                p === null ||
              ...
              kn(p)
                ...
                : ((d = null),
                  typeof p == 'string'
                    ...
                    : (y = ArrayBuffer.isView(p) ? p.byteLength : 0));
          }
          return (
            (s = a(e, p, s, i)),
            r !== null &&
    ...
    function Jt(e, t, s, i, r, a, p) {
      function d(A) {
        if (!k.errored) {
          (k.errored = !0), (k.value = null), (k.reason = A);
          var u = k.chunk;
          u !== null && u.status === 'blocked' && Fr(e, u, A);
        }
      }
      ...
      return (
        t.then(function (A) {
          try {
            p !== null && $n(p, A.byteLength, e);
            var u = s === ArrayBuffer ? A : new s(A);
            y !== '__proto__' && (r[a] = u),
              a === '' && k.value === null && (k.value = u);
          } catch (f) {
            d(f);
            return;
          }
    ...
    function fu(e, t, s) {
      ...
      var r = null,
        ...
        d = null,
        y = {
          enqueueModel: function (k) {
            if (d === null) {
              var A = Hu(e, k, -1);
              Br(A),
                A.status === 'fulfilled'
                  ? i(A.value)
                  : (A.then(i, y.error), (d = A));
            } else {
              A = d;
      ...
      return (
        ...
        zu(e, t, s, {
          enqueueModel: function (d) {
            a === i.length ? (i[a] = hu(e, d, !1)) : ea(e, i[a], d, !1), a++;
          },
          close: function (d) {
            if (!r)
              for (
                r = !0,
                  a === i.length ? (i[a] = hu(e, d, !0)) : ea(e, i[a], d, !0),
                  a++;
                a < i.length;
    ...
    function Dd(e, t, s, i, r, a) {
      if (i[0] === '$') {
        switch (i[1]) {
          ...
          case 'h':
            return (a = i.slice(2)), Di(e, a, t, s, null, Ad);
          case 'T':
            if (r === void 0 || e._temporaryReferences === void 0)
              throw Error(
                'Could not reference an opaque temporary reference. This is likely due to misconfiguring the temporaryReferences options on the server.'
              );
            return ld(e._temporaryReferences, r);
          case 'Q':
            return (a = i.slice(2)), Di(e, a, t, s, null, Nd);
          case 'W':
            return (a = i.slice(2)), Di(e, a, t, s, null, Rd);
          case 'K':
            for (
              t = i.slice(2),
                t = e._prefix + t + '_',
              ...
              if (((r = a[i]), r.startsWith(t))) {
                for (
                  var p = e.getAll(r), d = r.slice(t.length), y = 0;
                  y < p.length;
                  y++
                )
                  s.append(d, p[y]);
        ...
        return (i = i.slice(1)), Di(e, i, t, s, a, Od);
      }
    ...
    En.createClientModuleProxy = function (e) {
      return (e = ti({}, e, !1)), new Proxy(e, gu);
    };
    ...
    En.decodeAction = function (e, t) {
      ...
      return (
        e.forEach(function (a, p) {
          p.startsWith('$ACTION_')
            ? p.startsWith('$ACTION_REF_')
              ? r.has(p) ||
                (r.add(p),
                (a = '$ACTION_' + p.slice(12) + ':'),
                (a = Ju(e, t, a)),
                (i = mu(t, a)))
              : p.startsWith('$ACTION_ID_') &&
                !r.has(p) &&
                (r.add(p), (a = p.slice(11)), (i = mu(t, {id: a, bound: null})))
            : s.append(p, a);
        }),
        i === null
          ? null
      ...
      if (
        (t.forEach(function (p, d) {
          d.startsWith('$ACTION_REF_') &&
            ((p = '$ACTION_' + d.slice(12) + ':'), (r = Ju(t, s, p)));
        }),
        r === null)
      )
        return Promise.resolve(null);
      var a = r.id;
      return Promise.resolve(r.bound).then(function (p) {
        return p === null ? null : [e, i, a, p.length - 1];
      });
    };
  ...
  var It = Z((Ta) => {
    ...
    (function (e) {
      ...
      e[(e._enum = f)] = '_enum';
      let x = f + 1;
      e[(e._exports = x)] = '_exports';
      let g = x + 1;
      e[(e._from = g)] = '_from';
      let S = g + 1;
      e[(e._get = S)] = '_get';
      let E = S + 1;
      e[(e._global = E)] = '_global';
      let L = E + 1;
      e[(e._implements = L)] = '_implements';
      let H = L + 1;
      e[(e._infer = H)] = '_infer';
      let D = H + 1;
      e[(e._interface = D)] = '_interface';
      let c = D + 1;
      e[(e._is = c)] = '_is';
      let M = c + 1;
      e[(e._keyof = M)] = '_keyof';
      let z = M + 1;
      e[(e._mixins = z)] = '_mixins';
      let X = z + 1;
      ...
      let yn = qt + 1;
      e[(e._using = yn)] = '_using';
    })(e1 || (Ta.ContextualKeyword = e1 = {}));
  });
  var be = Z((jr) => {
    'use strict';
    ...
    (function (e) {
      ...
      e[(e.eof = g)] = 'eof';
      let S = 7680;
      e[(e.bracketL = S)] = 'bracketL';
      let E = 8192;
      e[(e.bracketR = E)] = 'bracketR';
      let L = 9728;
      e[(e.braceL = L)] = 'braceL';
      let H = 10752;
      e[(e.braceBarL = H)] = 'braceBarL';
      let D = 11264;
      e[(e.braceR = D)] = 'braceR';
      let c = 12288;
  ...
  var qr = Z((Ui) => {
    ...
    Ui.Scope = ya;
    var $r = class {
      constructor(t, s, i, r, a, p, d, y, k, A, u, f, x) {
    ...
    var ka = class e {
      ...
      __init7() {
        this.type = Bd.TokenType.eof;
      }
      __init8() {
        this.contextualKeyword = Fd.ContextualKeyword.NONE;
      }
      __init9() {
        this.start = 0;
      }
  ...
  var Qt = Z((Kr) => {
    ...
    (function (e) {
      ...
      let k = 35;
      e[(e.numberSign = k)] = 'numberSign';
      let A = 36;
      e[(e.dollarSign = A)] = 'dollarSign';
      let u = 37;
      e[(e.percentSign = u)] = 'percentSign';
      let f = 38;
      e[(e.ampersand = f)] = 'ampersand';
      let x = 39;
      e[(e.apostrophe = x)] = 'apostrophe';
      let g = 40;
      e[(e.leftParenthesis = g)] = 'leftParenthesis';
      let S = 41;
      e[(e.rightParenthesis = S)] = 'rightParenthesis';
      let E = 42;
      e[(e.asterisk = E)] = 'asterisk';
      let L = 43;
      e[(e.plusSign = L)] = 'plusSign';
      let H = 44;
      e[(e.comma = H)] = 'comma';
      let D = 45;
      e[(e.dash = D)] = 'dash';
      ...
      let yn = 67;
      e[(e.uppercaseC = yn)] = 'uppercaseC';
      let V = 68;
      e[(e.uppercaseD = V)] = 'uppercaseD';
      let W = 69;
      e[(e.uppercaseE = W)] = 'uppercaseE';
      let J = 70;
  ...
  var Zt = Z((ft) => {
    ...
    function t1(e) {
      let t = 1,
        s = 1;
      for (let i = 0; i < e; i++)
        ft.input.charCodeAt(i) === Kd.charCodes.lineFeed ? (t++, (s = 1)) : s++;
      return new Ur(t, s);
    }
    ft.locationForIndex = t1;
    function Wd(e, t, s, i) {
      (ft.input = e),
        (ft.state = new qd.default()),
        (ft.nextContextId = 1),
        (ft.isJSXEnabled = t),
  ...
  var cs = Z((tn) => {
    ...
    tn.hasFollowingLineBreak = Yd;
    function r1() {
      return ls.eat.call(void 0, As.TokenType.semi) || s1();
    }
    tn.isLineTerminator = r1;
    function Jd() {
      r1() || Wr('Unexpected token, expected ";"');
    }
    tn.semicolon = Jd;
    function Qd(e) {
  ...
  var xa = Z((Ps) => {
    ...
    Ps.WHITESPACE_CHARS = Zd;
    var em = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g;
    Ps.skipWhiteSpace = em;
    var tm = new Uint8Array(65536);
    Ps.IS_WHITESPACE = tm;
  ...
  var li = Z((vn) => {
    ...
    var im = new Uint8Array(65536);
    vn.IS_IDENTIFIER_CHAR = im;
    for (let e = 0; e < 128; e++) vn.IS_IDENTIFIER_CHAR[e] = sm(e) ? 1 : 0;
    for (let e = 128; e < 65536; e++) vn.IS_IDENTIFIER_CHAR[e] = 1;
    for (let e of nm.WHITESPACE_CHARS) vn.IS_IDENTIFIER_CHAR[e] = 0;
    vn.IS_IDENTIFIER_CHAR[8232] = 0;
    vn.IS_IDENTIFIER_CHAR[8233] = 0;
    var rm = vn.IS_IDENTIFIER_CHAR.slice();
    vn.IS_IDENTIFIER_START = rm;
    for (let e = o1.charCodes.digit0; e <= o1.charCodes.digit9; e++)
  ...
  var p1 = Z((ba) => {
    ...
    function am() {
      ...
      for (
        ...
        let r = c1.READ_WORD_TREE[e + (t - us.charCodes.lowercaseA) + 1];
        if (r === -1) break;
        (e = r), s++;
      }
      let i = c1.READ_WORD_TREE[e];
      if (i > -1 && !l1.IS_IDENTIFIER_CHAR[t]) {
        (xn.state.pos = s),
          i & 1
            ? _a.finishToken.call(void 0, i >>> 1)
            : _a.finishToken.call(void 0, u1.TokenType.name, i >>> 1);
        return;
      }
      for (; s < xn.input.length; ) {
        let r = xn.input.charCodeAt(s);
        if (l1.IS_IDENTIFIER_CHAR[r]) s++;
      ...
      (xn.state.pos = s), _a.finishToken.call(void 0, u1.TokenType.name);
    }
    ba.default = am;
  });
  var xt = Z((Be) => {
    ...
    (function (e) {
      ...
      let k = y + 1;
      e[(e.ObjectShorthand = k)] = 'ObjectShorthand';
      let A = k + 1;
      e[(e.ImportDeclaration = A)] = 'ImportDeclaration';
      let u = A + 1;
    ...
    Be.isNonTopLevelDeclaration = fm;
    function dm(e) {
      let t = e.identifierRole;
      return (
        t === it.TopLevelDeclaration ||
    ...
    Be.isBlockScopedDeclaration = mm;
    function Tm(e) {
      let t = e.identifierRole;
      return (
        t === it.FunctionScopedDeclaration ||
    ...
    Be.isFunctionScopedDeclaration = Tm;
    function ym(e) {
      return (
    ...
    Be.isObjectShorthandDeclaration = ym;
    var Hi = class {
      constructor() {
    ...
    Be.Token = Hi;
    function zr() {
      b.state.tokens.push(new Hi()), y1();
    }
    Be.next = zr;
    function km() {
      b.state.tokens.push(new Hi()), (b.state.start = b.state.pos), $m();
    }
    Be.nextTemplateToken = km;
    function vm() {
      b.state.type === ne.TokenType.assign && --b.state.pos, Bm();
    }
    Be.retokenizeSlashAsRegex = vm;
    function xm(e) {
    ...
    Be.pushTypeContext = xm;
    function gm(e) {
      b.state.isType = e;
    }
    Be.popTypeContext = gm;
    function d1(e) {
      return Sa(e) ? (zr(), !0) : !1;
    }
    Be.eat = d1;
    function _m(e) {
      let t = b.state.isType;
      (b.state.isType = !0), d1(e), (b.state.isType = t);
    }
    Be.eatTypeToken = _m;
    function Sa(e) {
    ...
    Be.lookaheadTypeAndKeyword = Cm;
    function m1() {
      return T1(b.state.pos);
    }
    Be.nextTokenStart = m1;
    function T1(e) {
    ...
    function wm() {
      return b.input.charCodeAt(m1());
    }
    Be.lookaheadCharCode = wm;
    function y1() {
      if (
        (v1(), (b.state.start = b.state.pos), b.state.pos >= b.input.length)
      ) {
    ...
    Be.skipSpace = v1;
    function Ve(e, t = cm.ContextualKeyword.NONE) {
    ...
    function Dm() {
      b.state.type === ne.TokenType.greaterThan && ((b.state.pos -= 1), x1());
    }
    Be.rescan_gt = Dm;
    function Mm(e) {
      let t = b.input.charCodeAt(b.state.pos + 1);
    ...
    function Bm() {
      ...
      ++b.state.pos, b1(), Ve(ne.TokenType.regexp);
    }
    function Ca() {
      for (;;) {
        let e = b.input.charCodeAt(b.state.pos);
    ...
    function b1() {
      for (; b.state.pos < b.input.length; ) {
        let e = b.input.charCodeAt(b.state.pos);
        if (f1.IS_IDENTIFIER_CHAR[e]) b.state.pos++;
  ...
  var Wi = Z((Ia) => {
    ...
    var C1 = be();
    function qm(e, t = e.currentIndex()) {
      let s = t + 1;
      if (Xr(e, s)) {
    ...
    function Xr(e, t) {
      let s = e.tokens[t];
      return s.type === C1.TokenType.braceR || s.type === C1.TokenType.comma;
    }
  });
  var w1 = Z((Ea) => {
    'use strict';
  ...
  var Pa = Z((Aa) => {
    ...
    function Km(e) {
      let [t, s] = S1(e.jsxPragma || 'React.createElement'),
        [i, r] = S1(e.jsxFragmentPragma || 'React.Fragment');
      ...
      La = class e extends Xm.default {
        ...
        constructor(t, s, i, r, a) {
          super(),
            ...
            e.prototype.__init4.call(this),
            e.prototype.__init5.call(this),
            (this.jsxPragmaInfo = Gm.default.call(void 0, a)),
...
` && this.lastLineNumber++,
        ...
        processTagIntro() {
          ...
          if (t === this.tokens.currentIndex() + 1) {
            ...
            E1(s) && this.tokens.replaceToken(`'${s}'`);
          }
...
`;
    ...
    function A1(e, t) {
      ...
      if (e[a] === '#') {
        ...
        let d;
        if (e[a] === 'x')
          for (p = 16, a++, d = a; a < e.length && Zm(e.charCodeAt(a)); ) a++;
        else for (d = a; a < e.length && Qm(e.charCodeAt(a)); ) a++;
        if (e[a] === ';') {
          let y = e.slice(d, a);
          y && (a++, (r = String.fromCodePoint(parseInt(y, p))));
        }
      } else
        for (; a < e.length && i++ < 10; ) {
          let p = e[a];
  ...
  var Fa = Z((Ma) => {
    ...
    var Qr = xt(),
      ...
      sT = eT(nT);
    function iT(e, t) {
      let s = sT.default.call(void 0, t),
        i = new Set();
      for (let r = 0; r < e.tokens.length; r++) {
        ...
        if (
          ...
          (!tT.startsWithLowerCase.call(void 0, p) ||
    ...
    var oT = xt(),
      ...
      Ba = class e {
        ...
        pruneTypeOnlyImports() {
          this.nonTypeIdentifiers = cT.getNonTypeIdentifiers.call(
            void 0,
            this.tokens,
            this.options
          );
        ...
        generateImportReplacements() {
          for (let [t, s] of this.importInfoByPath.entries()) {
            ...
            let k = this.getFreeIdentifierForPath(t),
              A;
            this.enableLegacyTypeScriptModuleInterop
              ? (A = k)
              : (A = r.length > 0 ? r[0] : this.getFreeIdentifierForPath(t));
            let u = `var ${k} = require('${t}');`;
            if (r.length > 0)
              for (let f of r) {
                let x = this.enableLegacyTypeScriptModuleInterop
                  ? k
              ...
              d.length > 0 && A !== k
                ? (u += ` var ${A} = ${this.helperManager.getHelperName(
                    'interopRequireWildcard'
                  )}(${k});`)
                : i.length > 0 &&
                  A !== k &&
            ...
            for (let {importedName: f, localName: x} of p)
              u += ` ${this.helperManager.getHelperName(
                'createNamedExportFrom'
              )}(${k}, '${x}', '${f}');`;
            for (let f of d) u += ` exports.${f} = ${A};`;
            y &&
              (u += ` ${this.helperManager.getHelperName(
                'createStarExport'
              )}(${k});`),
              this.importsToReplace.set(t, u);
            for (let f of i) this.identifierReplacements.set(f, `${A}.default`);
            for (let {importedName: f, localName: x} of a)
              this.identifierReplacements.set(x, `${k}.${f}`);
          }
        }
          ...
          for (let i = t + 2; ; i++)
            if (
              ...
              if (this.tokens.matches1AtIndex(1, me.TokenType.eq)) {
                ...
                if (oT.isDeclaration.call(void 0, r)) {
        ...
        getNamedImports(t) {
          ...
          for (;;) {
            ...
            let i = lT.default.call(void 0, this.tokens, t);
            if (
              ((t = i.endIndex),
              i.isType ||
    ...
    (function (e, t) {
            ...
            pe < z && (M = !1),
              ...
              A(S, X, D)
                ? ((X = k(S, X, E, 1)),
                  ...
                  (X = k(S, X, E, 3)),
                  A(S, X, D)
                    ? ((X = k(S, X, E, 4)), (ie = [pe, E[1], E[2], E[3], E[4]]))
                    : (ie = [pe, E[1], E[2], E[3]]))
                : (ie = [pe]),
              c.push(ie);
          }
          M || u(c), L.push(c), (H = D + 1);
        } while (H <= S.length);
        return L;
      }
      function y(S, E) {
        let L = S.indexOf(';', E);
        return L === -1 ? S.length : L;
      }
      function k(S, E, L, H) {
        let D = 0,
          c = 0,
          M = 0;
        do {
          let X = S.charCodeAt(E++);
          (M = a[X]), (D |= (M & 31) << c), (c += 5);
        } while (M & 32);
        let z = D & 1;
        return (D >>>= 1), z && (D = -2147483648 | -D), (L[H] += D), E;
      }
      function A(S, E, L) {
        return E >= L ? !1 : S.charCodeAt(E) !== 44;
      }
      function u(S) {
        S.sort(f);
      }
      ...
      function x(S) {
        ...
        for (let X = 0; X < S.length; X++) {
          let ie = S[X];
          if (
            (X > 0 && (M === L && ((z += p.decode(D)), (M = 0)), (D[M++] = 59)),
            ie.length !== 0)
          ) {
            E[0] = 0;
            for (let pe = 0; pe < ie.length; pe++) {
              let ae = ie[pe];
              M > H && ((z += p.decode(c)), D.copyWithin(0, H, M), (M -= H)),
                pe > 0 && (D[M++] = 44),
                (M = g(D, M, E, ae, 0)),
                ae.length !== 1 &&
                  ((M = g(D, M, E, ae, 1)),
                  (M = g(D, M, E, ae, 2)),
                  (M = g(D, M, E, ae, 3)),
                  ae.length !== 4 && (M = g(D, M, E, ae, 4)));
            }
          }
        }
        return z + p.decode(D.subarray(0, M));
      }
      function g(S, E, L, H, D) {
        let c = H[D],
          M = c - L[D];
        (L[D] = c), (M = M < 0 ? (-M << 1) | 1 : M << 1);
        do {
          let z = M & 31;
          (M >>>= 5), M > 0 && (z |= 32), (S[E++] = r[z]);
        } while (M > 0);
        return E;
      }
      (e.decode = d),
    ...
    (function (e, t) {
      ...
      (function (L) {
        (L[(L.Empty = 1)] = 'Empty'),
          (L[(L.Hash = 2)] = 'Hash'),
          (L[(L.Query = 3)] = 'Query'),
          (L[(L.RelativePath = 4)] = 'RelativePath'),
          (L[(L.AbsolutePath = 5)] = 'AbsolutePath'),
          (L[(L.SchemeRelative = 6)] = 'SchemeRelative'),
          (L[(L.Absolute = 7)] = 'Absolute');
      })(i || (i = {}));
      function r(L) {
        return e.test(L);
      }
      ...
      function f(L) {
        if (a(L)) {
          let D = k('http:' + L);
          return (D.scheme = ''), (D.type = i.SchemeRelative), D;
        }
        if (p(L)) {
          let D = k('http://foo.com' + L);
          return (D.scheme = ''), (D.host = ''), (D.type = i.AbsolutePath), D;
        }
        if (d(L)) return A(L);
        if (r(L)) return k(L);
        let H = k('http://foo.com/' + L);
        return (
          (H.scheme = ''),
          (H.host = ''),
          (H.type = L
      ...
      function x(L) {
        ...
        let H = L.lastIndexOf('/');
        return L.slice(0, H + 1);
      }
      function g(L, H) {
        S(H, H.type),
          L.path === '/' ? (L.path = H.path) : (L.path = x(H.path) + L.path);
      }
      function S(L, H) {
        let D = H <= i.RelativePath,
          c = L.path.split('/'),
          M = 1,
          z = 0,
          X = !1;
        ...
        let ie = '';
        for (let pe = 1; pe < M; pe++) ie += '/' + c[pe];
        (!ie || (X && !ie.endsWith('/..'))) && (ie += '/'), (L.path = ie);
      }
      function E(L, H) {
        if (!L && !H) return '';
        let D = f(L),
        ...
        if (H && c !== i.Absolute) {
          ...
          switch (c) {
            ...
            case i.RelativePath:
              g(D, z);
            case i.AbsolutePath:
              (D.user = z.user), (D.host = z.host), (D.port = z.port);
        ...
        S(D, c);
        let M = D.query + D.hash;
        switch (c) {
          case i.Hash:
          case i.Query:
            return M;
          case i.RelativePath: {
            let z = D.path.slice(1);
            return z ? (y(H || L) && !y(z) ? './' + z + M : z + M) : M || '.';
          }
          case i.AbsolutePath:
            return D.path + M;
          default:
            return D.scheme + '//' + D.user + D.host + D.port + D.path + M;
        }
      }
      return E;
    });
  ...
  var M1 = Z((no, D1) => {
    (function (e, t) {
      ...
      var r = i(s);
      function a(V, W) {
        return W && !W.endsWith('/') && (W += '/'), r.default(V, W);
      }
      function p(V) {
        if (!V) return '';
        let W = V.lastIndexOf('/');
      ...
      function g(V, W) {
        ...
        W || (V = V.slice());
        for (let re = J; re < V.length; re = S(V, re + 1)) V[re] = L(V[re], W);
        return V;
      }
      function S(V, W) {
        for (let J = W; J < V.length; J++) if (!E(V[J])) return J;
        return V.length;
      }
      function E(V) {
        for (let W = 1; W < V.length; W++) if (V[W][d] < V[W - 1][d]) return !1;
        return !0;
      }
      function L(V, W) {
        return W || (V = V.slice()), V.sort(H);
      }
      function H(V, W) {
        return V[d] - W[d];
      }
      ...
      function c(V, W, J, re) {
        for (; J <= re; ) {
          let ve = J + ((re - J) >> 1),
            he = V[ve][d] - W;
          if (he === 0) return (D = !0), ve;
          he < 0 ? (J = ve + 1) : (re = ve - 1);
        }
        return (D = !1), J - 1;
      }
      function M(V, W, J) {
        for (let re = J + 1; re < V.length && V[re][d] === W; J = re++);
        return J;
      }
      function z(V, W, J) {
        for (let re = J - 1; re >= 0 && V[re][d] === W; J = re--);
        return J;
      }
      function X() {
        return {lastKey: -1, lastNeedle: -1, lastIndex: -1};
      }
      function ie(V, W, J, re) {
        let {lastKey: ve, lastNeedle: he, lastIndex: Ie} = J,
          Ee = 0,
          Le = V.length - 1;
        if (re === ve) {
          if (W === he) return (D = Ie !== -1 && V[Ie][d] === W), Ie;
          W >= he ? (Ee = Ie === -1 ? 0 : Ie) : (Le = Ie);
        }
        return (
          (J.lastKey = re), (J.lastNeedle = W), (J.lastIndex = c(V, W, Ee, Le))
        );
      }
      function pe(V, W) {
        let J = W.map(He);
      ...
      function ae(V, W, J) {
        for (let re = V.length; re > W; re--) V[re] = V[re - 1];
        V[W] = J;
      }
      function He() {
      ...
      let qe = function (V, W) {
        ...
        if (!('sections' in J)) return new wt(J, W);
        let re = [],
          ve = [],
          he = [],
          Ie = [];
        Bt(J, W, re, ve, he, Ie, 0, 0, 1 / 0, 1 / 0);
        let Ee = {
          version: 3,
          file: J.file,
          names: Ie,
      ...
      function Bt(V, W, J, re, ve, he, Ie, Ee, Le, Xe) {
        let {sections: We} = V;
        for (let Ke = 0; Ke < We.length; Ke++) {
          ...
          if (Ke + 1 < We.length) {
            ...
            (bt = Math.min(Le, Ie + vt.line)),
              bt === Le
                ? (Tt = Math.min(Xe, Ee + vt.column))
                : bt < Le && (Tt = Ee + vt.column);
          }
          mt(ut, W, J, re, ve, he, Ie + pt.line, Ee + pt.column, bt, Tt);
        }
      }
      function mt(V, W, J, re, ve, he, Ie, Ee, Le, Xe) {
        if ('sections' in V) return Bt(...arguments);
        let We = new wt(V, W),
          Ke = re.length,
          ut = he.length,
          pt = e.decodedMappings(We),
          {resolvedSources: bt, sourcesContent: Tt} = We;
        if ((kt(re, bt), kt(he, We.names), Tt)) kt(ve, Tt);
        ...
        for (let vt = 0; vt < pt.length; vt++) {
          ...
          for (let ot = 0; ot < St.length; ot++) {
            ...
            let te = Ke + zt[y],
              ...
              Zn = zt[A];
            Dn.push(
              zt.length === 4 ? [Xt, te, Cn, Zn] : [Xt, te, Cn, Zn, ut + zt[u]]
            );
          }
        }
      }
      function kt(V, W) {
        for (let J = 0; J < W.length; J++) V.push(W[J]);
      }
      function At(V, W) {
        for (let J = V.length; J <= W; J++) V[J] = [];
        return V[W];
      }
      ...
      class wt {
        constructor(W, J) {
          let re = typeof W == 'string';
          if (!re && W._decodedMemo) return W;
          let ve = re ? JSON.parse(W) : W,
            {
              version: he,
              file: Ie,
              names: Ee,
          ...
          typeof ut == 'string'
            ...
            : ((this._encoded = void 0), (this._decoded = g(ut, re))),
            (this._decodedMemo = X()),
      ...
      (e.encodedMappings = (V) => {
        var W;
        return (W = V._encoded) !== null && W !== void 0
          ? W
          : (V._encoded = t.encode(V._decoded));
      }),
        (e.decodedMappings = (V) =>
          V._decoded || (V._decoded = t.decode(V._encoded))),
        (e.traceSegment = (V, W, J) => {
          let re = e.decodedMappings(V);
          return W >= re.length ? null : yn(re[W], V._decodedMemo, W, J, ct);
        }),
        (e.originalPositionFor = (V, {line: W, column: J, bias: re}) => {
          if ((W--, W < 0)) throw new Error(tt);
          if (J < 0) throw new Error(nt);
          let ve = e.decodedMappings(V);
          if (W >= ve.length) return Pt(null, null, null, null);
          let he = yn(ve[W], V._decodedMemo, W, J, re || ct);
        ...
        (e.generatedPositionFor = (
          ...
          let Ke = yn(We, Xe[Ee], J, re, ve || ct);
          return Ke == null ? qt(null, null) : qt(Ke[f] + 1, Ke[x]);
        }),
        (e.eachMapping = (V, W) => {
        ...
        (e.sourceContentFor = (V, W) => {
          let {sources: J, resolvedSources: re, sourcesContent: ve} = V;
          if (ve == null) return null;
          let he = J.indexOf(W);
          return he === -1 && (he = re.indexOf(W)), he === -1 ? null : ve[he];
        }),
        (e.presortedDecodedMap = (V, W) => {
          let J = new wt($t(V, []), W);
      ...
      function Pt(V, W, J, re) {
        return {source: V, line: W, column: J, name: re};
      }
      function qt(V, W) {
        return {line: V, column: W};
      }
      function yn(V, W, J, re, ve) {
        let he = ie(V, re, W, J);
        return (
          D ? (he = (ve === _t ? M : z)(V, re, he)) : ve === _t && he++,
  ...
  var B1 = Z((so, F1) => {
    (function (e, t) {
      ...
      let A;
      class u {
        constructor({file: M, sourceRoot: z} = {}) {
      ...
      (e.addSegment = (c, M, z, X, ie, pe, ae, He) =>
        A(!1, c, M, z, X, ie, pe, ae, He)),
        (e.maybeAddSegment = (c, M, z, X, ie, pe, ae, He) =>
          A(!0, c, M, z, X, ie, pe, ae, He)),
        (e.addMapping = (c, M) => D(!1, c, M)),
        (e.maybeAddMapping = (c, M) => D(!0, c, M)),
        (e.setSourceContent = (c, M, z) => {
        ...
        (e.toEncodedMap = (c) => {
          let M = e.toDecodedMap(c);
          return Object.assign(Object.assign({}, M), {
            mappings: s.encode(M.mappings),
          });
        }),
        (e.allMappings = (c) => {
          let M = [],
            {_mappings: z, _sources: X, _names: ie} = c;
          for (let pe = 0; pe < z.length; pe++) {
            ...
            for (let He = 0; He < ae.length; He++) {
              ...
              qe.length !== 1 &&
                ...
                M.push({generated: Bt, source: mt, original: kt, name: At});
            }
          }
          return M;
        }),
        (e.fromMap = (c) => {
          let M = new i.TraceMap(c),
            z = new u({file: M.file, sourceRoot: M.sourceRoot});
          return (
            E(z._names, M.names),
            E(z._sources, M.sources),
            (z._sourcesContent = M.sourcesContent || M.sources.map(() => null)),
            (z._mappings = i.decodedMappings(M)),
            z
          );
        }),
        (A = (c, M, z, X, ie, pe, ae, He, qe) => {
          let {
              _mappings: Bt,
              _sources: mt,
              _sourcesContent: kt,
            ...
            tt = f(Bt, z),
            nt = x(tt, X);
          if (!ie) return c && L(tt, nt) ? void 0 : g(tt, nt, [X]);
          let _t = t.put(mt, ie),
            ct = He ? t.put(At, He) : -1;
          if (
            (_t === kt.length && (kt[_t] = qe ?? null),
            !(c && H(tt, nt, _t, pe, ae, ct)))
          )
            return g(tt, nt, He ? [X, _t, pe, ae, ct] : [X, _t, pe, ae]);
        });
      function f(c, M) {
        for (let z = c.length; z <= M; z++) c[z] = [];
        return c[M];
      }
      function x(c, M) {
        let z = c.length;
        for (let X = z - 1; X >= 0; z = X--) {
          let ie = c[X];
          if (M >= ie[0]) break;
        }
        return z;
      ...
      function g(c, M, z) {
        for (let X = c.length; X > M; X--) c[X] = c[X - 1];
        c[M] = z;
      }
      function S(c) {
        let {length: M} = c,
          z = M;
        for (let X = z - 1; X >= 0 && !(c[X].length > 0); z = X, X--);
        z < M && (c.length = z);
      }
      function E(c, M) {
        for (let z = 0; z < M.length; z++) t.put(c, M[z]);
      }
      function L(c, M) {
        return M === 0 ? !0 : c[M - 1].length === 1;
      }
      function H(c, M, z, X, ie, pe) {
        if (M === 0) return !1;
        let ae = c[M - 1];
        return ae.length === 1
          ? !1
      ...
      function D(c, M, z) {
        let {generated: X, source: ie, original: pe, name: ae, content: He} = z;
        if (!ie)
          return A(c, M, X.line - 1, X.column, null, null, null, null, null);
        let qe = ie;
        return A(
          c,
          M,
  ...
  var j1 = Z((Ka) => {
    ...
    var Gi = B1(),
      V1 = Qt();
    function uT({code: e, mappings: t}, s, i, r, a) {
      let p = pT(r, a),
        d = new Gi.GenMapping({file: i.compiledFilename}),
        y = 0,
        k = t[0];
      for (; k === void 0 && y < t.length - 1; ) y++, (k = t[y]);
      let A = 0,
        u = 0;
      k !== u && Gi.maybeAddSegment.call(void 0, d, A, 0, s, A, 0);
      for (let S = 0; S < e.length; S++) {
        if (S === k) {
          let E = k - u,
            L = p[y];
          for (
            Gi.maybeAddSegment.call(void 0, d, A, E, s, A, L);
            (k === S || k === void 0) && y < t.length - 1;

          )
            y++, (k = t[y]);
        }
        e.charCodeAt(S) === V1.charCodes.lineFeed &&
          (A++,
          (u = S + 1),
          k !== u && Gi.maybeAddSegment.call(void 0, d, A, 0, s, A, 0));
      }
    ...
    function pT(e, t) {
      ...
      for (let p = 0; p < e.length; p++)
        p === r && ((s[i] = r - a), i++, (r = t[i].start)),
          e.charCodeAt(p) === V1.charCodes.lineFeed && (a = p + 1);
      return s;
    }
  });
  var $1 = Z((Ha) => {
  ...
  `,
      ...
      Ua = class e {
        ...
        emitHelpers() {
          ...
          for (let [s, i] of Object.entries(hT)) {
  ...
  var H1 = Z((Ga) => {
    ...
    function TT(e, t) {
      let s = [];
      for (let i of t)
        i.type === mT.TokenType.name && s.push(e.slice(i.start, i.end));
      return s;
    }
    Ga.default = TT;
  });
  var W1 = Z((Xa) => {
    ...
    var kT = H1(),
      ...
      za = class e {
        ...
        constructor(t, s) {
          e.prototype.__init.call(this),
            (this.usedNames = new Set(vT.default.call(void 0, t, s)));
        }
        claimFreeName(t) {
  ...
  var sl = Z((ce) => {
      ...
      return (
        (t.prototype.getChecker = function (s, i, r) {
          ...
          return p instanceof Dt || p instanceof t
            ? d
            : function (y, k) {
                return d(y, k) ? !0 : k.fail(null, a._failMsg, 0);
              };
        }),
        t
      );
    ...
    var tp = (function (e) {
      ...
      return (
        (t.prototype.getChecker = function (s, i) {
          ...
          return function (p, d) {
            for (var y = d.unionResolver(), k = 0; k < a.length; k++) {
              var A = a[k](p, y.createContext());
              if (A) return !0;
            }
    ...
    var sp = (function (e) {
      ...
      return (
        (t.prototype.getChecker = function (s, i) {
          ...
          return function (d, y) {
            return d === p ? !0 : y.fail(null, r._failMsg, -1);
          };
        }),
        t
      );
    ...
    var ip = (function (e) {
      ...
      return (
        (t.prototype.getChecker = function (s, i, r) {
          var a = this,
            p = this.bases.map(function (f) {
              return Qa(s, f).getChecker(s, i);
            }),
            d = this.props.map(function (f) {
              return f.ttype.getChecker(s, i);
            }),
            y = new J1.NoopContext(),
            k = this.props.map(function (f, x) {
              return !f.isOpt && !d[x](void 0, y);
            }),
            A = function (f, x) {
              if (typeof f != 'object' || f === null)
                return x.fail(null, 'is not an object', 0);
              for (var g = 0; g < p.length; g++) if (!p[g](f, x)) return !1;
              for (var g = 0; g < d.length; g++) {
                var S = a.props[g].name,
                  E = f[S];
                if (E === void 0) {
                  if (k[g]) return x.fail(S, 'is missing', 1);
                } else {
                  var L = d[g](E, x);
                  if (!L) return x.fail(S, null, 1);
                }
              }
              return !0;
            };
          ...
          return (
            ...
            function (f, x) {
              if (!A(f, x)) return !1;
              for (var g in f)
                if (!u.has(g)) return x.fail(g, 'is extraneous', 2);
              return !0;
            }
          );
        }),
    ...
    var ap = (function (e) {
      ...
      return (
        (t.prototype.getChecker = function (s, i) {
          var r = this,
            a = this.params.map(function (k) {
              return k.ttype.getChecker(s, i);
            }),
            p = new J1.NoopContext(),
            d = this.params.map(function (k, A) {
              return !k.isOpt && !a[A](void 0, p);
            }),
            y = function (k, A) {
              if (!Array.isArray(k)) return A.fail(null, 'is not an array', 0);
              for (var u = 0; u < a.length; u++) {
                var f = r.params[u];
                if (k[u] === void 0) {
                  if (d[u]) return A.fail(f.name, 'is missing', 1);
                } else {
                  var x = a[u](k[u], A);
                  if (!x) return A.fail(f.name, null, 1);
                }
              }
              return !0;
            };
          return i
            ? function (k, A) {
                return y(k, A)
                  ? k.length <= a.length
                    ? !0
                    : A.fail(a.length, 'is extraneous', 2)
                  : !1;
              }
            : y;
        }),
    ...
    ce.basicTypes = {
      ...
      Date: new Dt(X1('[object Date]'), 'is not a Date'),
      RegExp: new Dt(X1('[object RegExp]'), 'is not a RegExp'),
    };
    var MT = Object.prototype.toString;
    function X1(e) {
      return function (t) {
        return typeof t == 'object' && t && MT.call(t) === e;
      };
    }
    typeof Buffer < 'u' &&
  ...
  var il = Z((we) => {
    ...
    function jT() {
      for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
      for (
        var s = Object.assign.apply(Object, BT([{}, zi.basicTypes], e)),
          i = {},
          r = 0,
          a = e;
        r < a.length;
        ...
        for (var p = a[r], d = 0, y = Object.keys(p); d < y.length; d++) {
          var k = y[d];
          i[k] = new lp(s, p[k]);
        }
      return i;
    }
    we.createCheckers = jT;
    var lp = (function () {
      function e(t, s, i) {
        if (
          (i === void 0 && (i = 'value'),
  ...
  var cp = Z((Gn) => {
    ...
    Gn.Transform = KT;
    var UT = Qe.iface([], {compiledFilename: 'string'});
    Gn.SourceMapOptions = UT;
    var HT = Qe.iface([], {
  ...
  var up = Z((rl) => {
    ...
    var zT = il(),
      XT = cp(),
      YT = GT(XT),
      {Options: JT} = zT.createCheckers.call(void 0, YT.default);
    function QT(e) {
      JT.strictCheck(e);
    }
    rl.validateOptions = QT;
  });
  var lo = Z((Nn) => {
    'use strict';
    ...
    Nn.markPriorBindingIdentifier = dp;
    function ll(e) {
      switch (gt.state.type) {
        ...
        case fn.TokenType.name: {
          (gt.state.type = fn.TokenType.name), fp(e);
          return;
        }
        case fn.TokenType.bracketL: {
          Mt.next.call(void 0), mp(fn.TokenType.bracketR, e, !0);
          return;
        }
    ...
    Nn.parseBindingList = mp;
    function ny(e, t) {
      e &&
        pp.tsParseModifiers.call(void 0, [
    ...
    function Tp() {
      gt.isFlowEnabled
        ? ZT.flowParseAssignableListItemTypes.call(void 0)
        : gt.isTypeScriptEnabled &&
          pp.tsParseAssignableListItemTypes.call(void 0);
    }
    function al(e, t = !1) {
  ...
  var hi = Z((Oe) => {
    ...
    function iy() {
      return (
        ...
        !!(w.state.type & T.TokenType.IS_KEYWORD) ||
    ...
    function gp() {
      ...
      return (
        ...
        (v.match.call(void 0, T.TokenType.bracketL) ||
          ...
          iy()) &&
        !U.hasPrecedingLineBreak.call(void 0)
          ? !0
          : (w.state.restoreFromSnapshot(e), !1)
      );
    }
    function _p(e) {
      for (; dl(e) !== null; );
    }
    Oe.tsParseModifiers = _p;
    function dl(e) {
      if (!v.match.call(void 0, T.TokenType.name)) return null;
      let t = w.state.contextualKeyword;
      if (e.indexOf(t) !== -1 && gp()) {
        switch (t) {
    ...
    function ly() {
      U.expect.call(void 0, T.TokenType._typeof),
        v.match.call(void 0, T.TokenType._import) ? bp() : Zi(),
        !U.hasPrecedingLineBreak.call(void 0) &&
          v.match.call(void 0, T.TokenType.lessThan) &&
          Ti();
    }
    function bp() {
      U.expect.call(void 0, T.TokenType._import),
        U.expect.call(void 0, T.TokenType.parenL),
        U.expect.call(void 0, T.TokenType.string),
        U.expect.call(void 0, T.TokenType.parenR),
        v.eat.call(void 0, T.TokenType.dot) && Zi(),
        v.match.call(void 0, T.TokenType.lessThan) && Ti();
    }
    function cy() {
      v.eat.call(void 0, T.TokenType._const);
      let e = v.eat.call(void 0, T.TokenType._in),
        t = U.eatContextual.call(void 0, oe.ContextualKeyword._out);
      v.eat.call(void 0, T.TokenType._const),
        (e || t) && !v.match.call(void 0, T.TokenType.name)
          ? (w.state.tokens[w.state.tokens.length - 1].type = T.TokenType.name)
          : _e.parseIdentifier.call(void 0),
    ...
    function uo() {
      ...
      for (
        ...
        v.match.call(void 0, T.TokenType.typeParameterStart)
          ? v.next.call(void 0)
          : U.unexpected.call(void 0);
        !v.eat.call(void 0, T.TokenType.greaterThan) && !w.state.error;

      )
        cy(), v.eat.call(void 0, T.TokenType.comma);
    ...
    function co() {
      v.eat.call(void 0, T.TokenType.comma) || U.semicolon.call(void 0);
    }
    function yp() {
    ...
    function py() {
      ...
      return w.state.restoreFromSnapshot(e), t;
    }
    function Cp() {
      if (!(v.match.call(void 0, T.TokenType.bracketL) && py())) return !1;
      let e = v.pushTypeContext.call(void 0, 0);
      return (
        U.expect.call(void 0, T.TokenType.bracketL),
        _e.parseIdentifier.call(void 0),
        tr(),
        U.expect.call(void 0, T.TokenType.bracketR),
        er(),
        co(),
        v.popTypeContext.call(void 0, e),
        !0
    ...
    function hy() {
      ...
      Cp() ||
        ((U.isContextual.call(void 0, oe.ContextualKeyword._get) ||
          U.isContextual.call(void 0, oe.ContextualKeyword._set)) &&
          gp(),
    ...
    function wp() {
      for (
        U.expect.call(void 0, T.TokenType.braceL);
        !v.eat.call(void 0, T.TokenType.braceR) && !w.state.error;
    ...
    function my() {
      return (
        ...
        v.eat.call(void 0, T.TokenType.minus)
          ? U.isContextual.call(void 0, oe.ContextualKeyword._readonly)
          : (U.isContextual.call(void 0, oe.ContextualKeyword._readonly) &&
              v.next.call(void 0),
            !v.match.call(void 0, T.TokenType.bracketL) ||
    ...
    function Ty() {
      _e.parseIdentifier.call(void 0),
        U.expect.call(void 0, T.TokenType._in),
        rt();
    }
    function yy() {
      U.expect.call(void 0, T.TokenType.braceL),
        ...
        v.match.call(void 0, T.TokenType.minus)
          ? (v.next.call(void 0),
            U.expectContextual.call(void 0, oe.ContextualKeyword._readonly))
          : U.eatContextual.call(void 0, oe.ContextualKeyword._readonly),
        U.expect.call(void 0, T.TokenType.bracketL),
        Ty(),
        U.eatContextual.call(void 0, oe.ContextualKeyword._as) && rt(),
        U.expect.call(void 0, T.TokenType.bracketR),
        v.match.call(void 0, T.TokenType.plus) ||
        v.match.call(void 0, T.TokenType.minus)
          ? (v.next.call(void 0), U.expect.call(void 0, T.TokenType.question))
          : v.eat.call(void 0, T.TokenType.question),
        Ny(),
        U.semicolon.call(void 0),
        U.expect.call(void 0, T.TokenType.braceR);
    }
    function ky() {
      for (
        U.expect.call(void 0, T.TokenType.bracketL);
        !v.eat.call(void 0, T.TokenType.bracketR) && !w.state.error;

      )
        vy(), v.eat.call(void 0, T.TokenType.comma);
    }
    function vy() {
    ...
    function gy() {
      for (
        ...
        !v.match.call(void 0, T.TokenType.backQuote) && !w.state.error;

      )
        U.expect.call(void 0, T.TokenType.dollarBraceL),
          rt(),
    ...
    function cl(e) {
      e === hs.TSAbstractConstructorType &&
        U.expectContextual.call(void 0, oe.ContextualKeyword._abstract),
        (e === hs.TSConstructorType || e === hs.TSAbstractConstructorType) &&
          U.expect.call(void 0, T.TokenType._new);
      let t = w.state.inDisallowConditionalTypesContext;
      (w.state.inDisallowConditionalTypesContext = !1),
        ml(T.TokenType.arrow),
        (w.state.inDisallowConditionalTypesContext = t);
    }
    function _y() {
      switch (w.state.type) {
        ...
        case T.TokenType._this: {
          ay(),
            U.isContextual.call(void 0, oe.ContextualKeyword._is) &&
              !U.hasPrecedingLineBreak.call(void 0) &&
              oy();
          return;
        }
        ...
        case T.TokenType.backQuote:
          ...
          return;
        default:
          if (w.state.type & T.TokenType.IS_KEYWORD) {
            v.next.call(void 0),
              (w.state.tokens[w.state.tokens.length - 1].type =
                T.TokenType.name);
            return;
    ...
    function by() {
      for (
        ...
        v.eat.call(void 0, T.TokenType.bracketR) ||
          (rt(), U.expect.call(void 0, T.TokenType.bracketR));
    }
    function Cy() {
      if (
        (U.expectContextual.call(void 0, oe.ContextualKeyword._infer),
        _e.parseIdentifier.call(void 0),
        v.match.call(void 0, T.TokenType._extends))
      ) {
        let e = w.state.snapshot();
        U.expect.call(void 0, T.TokenType._extends);
        let t = w.state.inDisallowConditionalTypesContext;
        (w.state.inDisallowConditionalTypesContext = !0),
          rt(),
          (w.state.inDisallowConditionalTypesContext = t),
          (w.state.error ||
            (!w.state.inDisallowConditionalTypesContext &&
              v.match.call(void 0, T.TokenType.question))) &&
            w.state.restoreFromSnapshot(e);
      }
    }
    function pl() {
      if (
        U.isContextual.call(void 0, oe.ContextualKeyword._keyof) ||
        U.isContextual.call(void 0, oe.ContextualKeyword._unique) ||
        U.isContextual.call(void 0, oe.ContextualKeyword._readonly)
      )
        v.next.call(void 0), pl();
      else if (U.isContextual.call(void 0, oe.ContextualKeyword._infer)) Cy();
      else {
        let e = w.state.inDisallowConditionalTypesContext;
        (w.state.inDisallowConditionalTypesContext = !1),
          by(),
          (w.state.inDisallowConditionalTypesContext = e);
      }
    }
    function vp() {
      if (
    ...
    function wy() {
      if (
        ...
        for (; v.eat.call(void 0, T.TokenType.bitwiseOR); ) vp();
    }
    function Sy() {
      return v.match.call(void 0, T.TokenType.lessThan)
        ? !0
        : v.match.call(void 0, T.TokenType.parenL) && Ey();
    }
    function Iy() {
      if (
        v.match.call(void 0, T.TokenType.name) ||
      ...
      if (
        ...
        let e = 1;
        for (v.next.call(void 0); e > 0 && !w.state.error; )
          v.match.call(void 0, T.TokenType.braceL) ||
          v.match.call(void 0, T.TokenType.bracketL)
            ? e++
    ...
    function Qi(e) {
      ...
      U.expect.call(void 0, e), Ry() || rt(), v.popTypeContext.call(void 0, t);
    }
    function Py() {
    ...
    function Ry() {
      let e = w.state.snapshot();
      return U.isContextual.call(void 0, oe.ContextualKeyword._asserts)
        ? (v.next.call(void 0),
          U.eatContextual.call(void 0, oe.ContextualKeyword._is)
            ? (rt(), !0)
            : ul() || v.match.call(void 0, T.TokenType._this)
            ? (v.next.call(void 0),
              U.eatContextual.call(void 0, oe.ContextualKeyword._is) && rt(),
              !0)
            : (w.state.restoreFromSnapshot(e), !1))
        : ul() || v.match.call(void 0, T.TokenType._this)
        ? (v.next.call(void 0),
    ...
    function tr() {
      let e = v.pushTypeContext.call(void 0, 0);
      U.expect.call(void 0, T.TokenType.colon),
        rt(),
        v.popTypeContext.call(void 0, e);
    }
    ...
    function rt() {
      ...
      (w.state.inDisallowConditionalTypesContext = !0),
        hl(),
        (w.state.inDisallowConditionalTypesContext = e),
        U.expect.call(void 0, T.TokenType.question),
        rt(),
        U.expect.call(void 0, T.TokenType.colon),
        rt();
    }
    ...
    function Ly() {
      return (
        U.isContextual.call(void 0, oe.ContextualKeyword._abstract) &&
    ...
    function Oy() {
      ...
      rt(),
        U.expect.call(void 0, T.TokenType.greaterThan),
        v.popTypeContext.call(void 0, e),
        _e.parseMaybeUnary.call(void 0);
    }
    Oe.tsParseTypeAssertion = Oy;
    function Dy() {
      if (v.eat.call(void 0, T.TokenType.jsxTagStart)) {
        ...
        for (
          ;
          !v.match.call(void 0, T.TokenType.greaterThan) && !w.state.error;

        )
          rt(), v.eat.call(void 0, T.TokenType.comma);
        sy.nextJSXTagToken.call(void 0), v.popTypeContext.call(void 0, e);
      }
    }
    Oe.tsTryParseJSXTypeArgument = Dy;
    function Sp() {
      for (; !v.match.call(void 0, T.TokenType.braceL) && !w.state.error; )
        My(), v.eat.call(void 0, T.TokenType.comma);
    }
    function My() {
      Zi(), v.match.call(void 0, T.TokenType.lessThan) && Ti();
    }
    function Fy() {
      di.parseBindingIdentifier.call(void 0, !1),
        mi(),
        v.eat.call(void 0, T.TokenType._extends) && Sp(),
        wp();
    }
    function By() {
      di.parseBindingIdentifier.call(void 0, !1),
        mi(),
        U.expect.call(void 0, T.TokenType.eq),
        rt(),
        U.semicolon.call(void 0);
    }
    function Vy() {
      if (
        ...
        let e = w.state.tokens.length - 1;
        _e.parseMaybeAssign.call(void 0),
          (w.state.tokens[e].rhsEndIndex = w.state.tokens.length);
      }
    }
    function Tl() {
      for (
    ...
    function yl() {
      U.expect.call(void 0, T.TokenType.braceL),
        Rn.parseBlockBody.call(void 0, T.TokenType.braceR);
    }
    function fl() {
      di.parseBindingIdentifier.call(void 0, !1),
        v.eat.call(void 0, T.TokenType.dot) ? fl() : yl();
    }
    function Ip() {
      U.isContextual.call(void 0, oe.ContextualKeyword._global)
        ? _e.parseIdentifier.call(void 0)
        : v.match.call(void 0, T.TokenType.string)
    ...
    Oe.tsParseImportEqualsDeclaration = Ep;
    function jy() {
      return (
        U.isContextual.call(void 0, oe.ContextualKeyword._require) &&
    ...
    function qy() {
      U.expectContextual.call(void 0, oe.ContextualKeyword._require),
        U.expect.call(void 0, T.TokenType.parenL),
        v.match.call(void 0, T.TokenType.string) || U.unexpected.call(void 0),
        _e.parseLiteral.call(void 0),
        U.expect.call(void 0, T.TokenType.parenR);
    }
    function Ky() {
      if (U.isLineTerminator.call(void 0)) return !1;
      switch (w.state.type) {
        ...
        case T.TokenType._const:
          if (
            ...
            U.isLookaheadContextual.call(void 0, oe.ContextualKeyword._enum)
          ) {
            let e = v.pushTypeContext.call(void 0, 1);
            return (
              U.expect.call(void 0, T.TokenType._const),
              U.expectContextual.call(void 0, oe.ContextualKeyword._enum),
              (w.state.tokens[w.state.tokens.length - 1].type =
                T.TokenType._enum),
              Tl(),
              v.popTypeContext.call(void 0, e),
    ...
    function xp() {
      return po(w.state.contextualKeyword, !0);
    }
    function Uy(e) {
      switch (e) {
        case oe.ContextualKeyword._declare: {
          let t = w.state.tokens.length - 1;
          if (Ky()) return (w.state.tokens[t].type = T.TokenType._declare), !0;
          break;
        }
        case oe.ContextualKeyword._global:
          if (v.match.call(void 0, T.TokenType.braceL)) return yl(), !0;
          break;
        default:
          return po(e, !1);
      }
      ...
      switch (e) {
        ...
        case oe.ContextualKeyword._interface:
          if (fi(t) && v.match.call(void 0, T.TokenType.name)) {
            ...
            return Fy(), v.popTypeContext.call(void 0, s), !0;
          }
          break;
        case oe.ContextualKeyword._module:
          if (fi(t)) {
            if (v.match.call(void 0, T.TokenType.string)) {
              let s = v.pushTypeContext.call(void 0, t ? 2 : 1);
              return Ip(), v.popTypeContext.call(void 0, s), !0;
        ...
        case oe.ContextualKeyword._type:
          if (fi(t) && v.match.call(void 0, T.TokenType.name)) {
            let s = v.pushTypeContext.call(void 0, t ? 2 : 1);
            return By(), v.popTypeContext.call(void 0, s), !0;
          }
          break;
        default:
          break;
    ...
    function fi(e) {
      return e ? (v.next.call(void 0), !0) : !U.isLineTerminator.call(void 0);
    }
    function Hy() {
      let e = w.state.snapshot();
      return (
        ...
        Py(),
        U.expect.call(void 0, T.TokenType.arrow),
        w.state.error
          ? (w.state.restoreFromSnapshot(e), !1)
    ...
    function kl() {
      w.state.type === T.TokenType.bitShiftL &&
        ((w.state.pos -= 1), v.finishToken.call(void 0, T.TokenType.lessThan)),
        Ti();
    }
    function Ti() {
      let e = v.pushTypeContext.call(void 0, 0);
      for (
        U.expect.call(void 0, T.TokenType.lessThan);
        !v.eat.call(void 0, T.TokenType.greaterThan) && !w.state.error;
    ...
    function Wy() {
      if (v.match.call(void 0, T.TokenType.name))
        switch (w.state.contextualKeyword) {
          case oe.ContextualKeyword._abstract:
          case oe.ContextualKeyword._declare:
          case oe.ContextualKeyword._enum:
          case oe.ContextualKeyword._interface:
    ...
    Oe.tsIsDeclarationStart = Wy;
    function Gy(e, t) {
      if (
        (v.match.call(void 0, T.TokenType.colon) && Qi(T.TokenType.colon),
        !v.match.call(void 0, T.TokenType.braceL) &&
          U.isLineTerminator.call(void 0))
      ) {
        let s = w.state.tokens.length - 1;
        for (
          ;
          s >= 0 &&
          (w.state.tokens[s].start >= e ||
            w.state.tokens[s].type === T.TokenType._default ||
            w.state.tokens[s].type === T.TokenType._export);

        )
          (w.state.tokens[s].isType = !0), s--;
        return;
      }
      _e.parseFunctionBody.call(void 0, !1, t);
    }
    Oe.tsParseFunctionBodyAndFinish = Gy;
    function zy(e, t, s) {
      if (
        !U.hasPrecedingLineBreak.call(void 0) &&
      ...
      if (
        ...
        let i = w.state.snapshot();
        if (!t && _e.atPossibleAsync.call(void 0) && Hy()) return;
        if (
          (kl(),
          !t && v.eat.call(void 0, T.TokenType.parenL)
            ? ((w.state.tokens[w.state.tokens.length - 1].subscriptStartIndex =
                e),
              _e.parseCallExpressionArguments.call(void 0))
            : v.match.call(void 0, T.TokenType.backQuote)
            ? _e.parseTemplate.call(void 0)
            : (w.state.type === T.TokenType.greaterThan ||
                (w.state.type !== T.TokenType.parenL &&
                  w.state.type & T.TokenType.IS_EXPRESSION_START &&
                  !U.hasPrecedingLineBreak.call(void 0))) &&
              U.unexpected.call(void 0),
          w.state.error)
        )
          w.state.restoreFromSnapshot(i);
        else return;
      } else
        !t &&
    ...
    Oe.tsParseSubscript = zy;
    function Xy() {
      if (v.eat.call(void 0, T.TokenType._import))
        return (
          U.isContextual.call(void 0, oe.ContextualKeyword._type) &&
            v.lookaheadType.call(void 0) !== T.TokenType.eq &&
            U.expectContextual.call(void 0, oe.ContextualKeyword._type),
          Ep(),
          !0
        );
      if (v.eat.call(void 0, T.TokenType.eq))
        return _e.parseExpression.call(void 0), U.semicolon.call(void 0), !0;
      if (U.eatContextual.call(void 0, oe.ContextualKeyword._as))
        return (
          U.expectContextual.call(void 0, oe.ContextualKeyword._namespace),
          _e.parseIdentifier.call(void 0),
          U.semicolon.call(void 0),
          !0
        );
      if (U.isContextual.call(void 0, oe.ContextualKeyword._type)) {
    ...
    function Yy() {
      ...
      if (
        ...
        (w.state.tokens[w.state.tokens.length - 1].identifierRole =
          v.IdentifierRole.ImportDeclaration),
          (w.state.tokens[w.state.tokens.length - 2].isType = !0),
          (w.state.tokens[w.state.tokens.length - 1].isType = !0);
        return;
      }
      if (
        (_e.parseIdentifier.call(void 0),
        ...
        (w.state.tokens[w.state.tokens.length - 3].identifierRole =
      ...
      _e.parseIdentifier.call(void 0),
        ...
        (w.state.tokens[w.state.tokens.length - 1].identifierRole =
          v.IdentifierRole.ImportDeclaration),
        (w.state.tokens[w.state.tokens.length - 4].isType = !0),
        (w.state.tokens[w.state.tokens.length - 3].isType = !0),
        (w.state.tokens[w.state.tokens.length - 2].isType = !0),
        (w.state.tokens[w.state.tokens.length - 1].isType = !0);
    }
    Oe.tsParseImportSpecifier = Yy;
    function Jy() {
      if (
        (_e.parseIdentifier.call(void 0),
        v.match.call(void 0, T.TokenType.comma) ||
    ...
    function Qy() {
      if (
        ...
        return (
          (w.state.type = T.TokenType._abstract),
          v.next.call(void 0),
          Rn.parseClass.call(void 0, !0, !0),
          !0
        );
      if (U.isContextual.call(void 0, oe.ContextualKeyword._interface)) {
    ...
    Oe.tsTryParseExportDefaultExpression = Qy;
    function Zy() {
      if (w.state.type === T.TokenType._const) {
    ...
    Oe.tsTryParseStatementContent = Zy;
    function ek(e) {
      ...
      if (Cp()) {
        let r = e ? t - 1 : t;
        for (let a = r; a < s; a++) w.state.tokens[a].isType = !0;
        return !0;
      }
      return !1;
    }
    Oe.tsTryParseClassMemberWithIsStatic = ek;
    function tk(e) {
      Uy(e) || U.semicolon.call(void 0);
    }
    Oe.tsParseIdentifierStatement = tk;
    function nk() {
      let e = U.eatContextual.call(void 0, oe.ContextualKeyword._declare);
      e &&
        (w.state.tokens[w.state.tokens.length - 1].type = T.TokenType._declare);
      let t = !1;
      if (v.match.call(void 0, T.TokenType.name))
        if (e) {
          let s = v.pushTypeContext.call(void 0, 2);
          (t = xp()), v.popTypeContext.call(void 0, s);
        } else t = xp();
      if (!t)
        if (e) {
          let s = v.pushTypeContext.call(void 0, 2);
    ...
    Oe.tsParseExportDeclaration = nk;
    function sk(e) {
      if (
        (e &&
          (v.match.call(void 0, T.TokenType.lessThan) ||
            v.match.call(void 0, T.TokenType.bitShiftL)) &&
          kl(),
        U.eatContextual.call(void 0, oe.ContextualKeyword._implements))
      ) {
        w.state.tokens[w.state.tokens.length - 1].type =
          T.TokenType._implements;
        let t = v.pushTypeContext.call(void 0, 1);
        Sp(), v.popTypeContext.call(void 0, t);
      }
    }
    Oe.tsAfterParseClassSuper = sk;
    function ik() {
      mi();
    }
    Oe.tsStartParseObjPropValue = ik;
    function rk() {
      mi();
    }
    Oe.tsStartParseFunctionParams = rk;
    function ok() {
      let e = v.pushTypeContext.call(void 0, 0);
      U.hasPrecedingLineBreak.call(void 0) ||
        v.eat.call(void 0, T.TokenType.bang),
    ...
    Oe.tsAfterParseVarHead = ok;
    function ak() {
      v.match.call(void 0, T.TokenType.colon) && tr();
    }
    Oe.tsStartParseAsyncArrowFromCallExpression = ak;
    function lk(e, t) {
      return w.isJSXEnabled ? Ap(e, t) : Pp(e, t);
    }
    Oe.tsParseMaybeAssign = lk;
    function Ap(e, t) {
      if (!v.match.call(void 0, T.TokenType.lessThan))
        return _e.baseParseMaybeAssign.call(void 0, e, t);
      let s = w.state.snapshot(),
        i = _e.baseParseMaybeAssign.call(void 0, e, t);
      if (w.state.error) w.state.restoreFromSnapshot(s);
      else return i;
      return (
        (w.state.type = T.TokenType.typeParameterStart),
        uo(),
        (i = _e.baseParseMaybeAssign.call(void 0, e, t)),
        i || U.unexpected.call(void 0),
        i
      );
    }
    Oe.tsParseMaybeAssignWithJSX = Ap;
    function Pp(e, t) {
      if (!v.match.call(void 0, T.TokenType.lessThan))
        return _e.baseParseMaybeAssign.call(void 0, e, t);
      let s = w.state.snapshot();
      ...
      if ((i || U.unexpected.call(void 0), w.state.error))
        w.state.restoreFromSnapshot(s);
      else return i;
      return _e.baseParseMaybeAssign.call(void 0, e, t);
    }
    Oe.tsParseMaybeAssignWithoutJSX = Pp;
    function ck() {
      if (v.match.call(void 0, T.TokenType.colon)) {
        let e = w.state.snapshot();
        Qi(T.TokenType.colon),
          U.canInsertSemicolon.call(void 0) && U.unexpected.call(void 0),
          v.match.call(void 0, T.TokenType.arrow) || U.unexpected.call(void 0),
          w.state.error && w.state.restoreFromSnapshot(e);
      }
    ...
    Oe.tsParseAssignableListItemTypes = uk;
    function pk() {
      (v.match.call(void 0, T.TokenType.lessThan) ||
        v.match.call(void 0, T.TokenType.bitShiftL)) &&
        kl(),
    ...
    Oe.tsParseMaybeDecoratorArguments = pk;
  });
  var vl = Z((fo) => {
    'use strict';
    ...
    function mk() {
      ...
      } while (Np.IS_IDENTIFIER_CHAR[e] || e === at.charCodes.dash);
    ...
    function kk(e) {
      ...
      Lp(), fe.isTypeScriptEnabled && hk.tsTryParseJSXTypeArgument.call(void 0);
      let t = !1;
      for (
        ;
        ...
        t &&
          ...
          Rp(Se.IdentifierRole.ObjectKey),
          Se.match.call(void 0, Me.TokenType.eq) && (dn(), Tk());
      }
      let s = Se.match.call(void 0, Me.TokenType.slash);
      return s && dn(), s;
    }
    function vk() {
      Se.match.call(void 0, Me.TokenType.jsxTagEnd) || Lp();
    }
    function Op() {
    ...
    function dn() {
      ...
      if (Np.IS_IDENTIFIER_START[e]) mk();
      else if (
  ...
  var Fp = Z((To) => {
    ...
    function bk(e) {
      ...
      xk.baseParseConditional.call(void 0, e);
    }
    To.typedParseConditional = bk;
    function Ck() {
      mo.eatTypeToken.call(void 0, ki.TokenType.question),
        mo.match.call(void 0, ki.TokenType.colon) &&
          (Mp.isTypeScriptEnabled
            ? _k.tsParseTypeAnnotation.call(void 0)
            : Mp.isFlowEnabled && gk.flowParseTypeAnnotation.call(void 0));
    }
    To.typedParseParenItem = Ck;
  });
  var Ns = Z((et) => {
    'use strict';
    ...
    function $p(e, t) {
      if (K.match.call(void 0, B.TokenType._yield)) return Kk(), !1;
    ...
    et.baseParseMaybeAssign = $p;
    function Ik(e) {
      return Ak(e) ? !0 : (Ek(e), !1);
    }
    function Ek(e) {
      j.isTypeScriptEnabled || j.isFlowEnabled
        ? Bp.typedParseConditional.call(void 0, e)
        : qp(e);
    }
    function qp(e) {
    ...
    et.baseParseConditional = qp;
    function Ak(e) {
      let t = j.state.tokens.length;
      return rr() ? !0 : (yo(t, -1, e), !1);
    }
    function yo(e, t, s) {
      if (
      ...
      if (i > 0 && (!s || !K.match.call(void 0, B.TokenType._in)) && i > t) {
        ...
        rr(),
          yo(a, r & B.TokenType.IS_RIGHT_ASSOCIATIVE ? i - 1 : i, s),
          r === B.TokenType.nullishCoalescing &&
    ...
    function rr() {
      ...
      if (
        ...
        K.lookaheadCharCode.call(void 0) === jp.charCodes.leftCurlyBrace &&
    ...
    et.parseExprSubscripts = Kp;
    function bl(e, t = !1) {
      j.isFlowEnabled ? Yn.flowParseSubscripts.call(void 0, e, t) : Up(e, t);
    }
    function Up(e, t = !1) {
      let s = new vo(!1);
      do Pk(e, t, s);
    ...
    function _o() {
      ...
      if (K.match.call(void 0, B.TokenType.lessThan) && j.isJSXEnabled)
        return (
          ...
          wk.jsxParseElement.call(void 0),
          K.next.call(void 0),
          !1
        );
      ...
      switch (j.state.type) {
        ...
        case B.TokenType.bracketL:
          return K.next.call(void 0), Jp(B.TokenType.bracketR, !0), !1;
        ...
        case B.TokenType.hash: {
          ...
          return (
            Sk.IS_IDENTIFIER_START[t] || t === jp.charCodes.backslash
              ? xo()
              : K.next.call(void 0),
            !1
          );
      ...
      return (
        ...
        e && Dk() && gl()
          ? (j.state.restoreFromSnapshot(t),
            ...
            gl(),
            ir(s),
            j.state.error ? (j.state.restoreFromSnapshot(t), zp(!1), !1) : !0)
          : !1
      );
    }
    function Dk() {
    ...
    function wl() {
      (j.isTypeScriptEnabled || j.isFlowEnabled) &&
        Bp.typedParseParenItem.call(void 0);
    }
    function Mk() {
      if (
      ...
      Fk(),
        ...
        K.eat.call(void 0, B.TokenType.parenL) && Jp(B.TokenType.parenR);
    }
    function Fk() {
    ...
    function _l(e, t) {
      ...
      let i = j.state.tokens.length,
        r = t;
      gn.parseFunctionParams.call(void 0, r, s), Yp(e, s);
      let a = j.state.tokens.length;
      j.state.scopes.push(new Vp.Scope(i, a, !0)), j.state.scopeDepth--;
    }
    et.parseMethod = _l;
    function ir(e) {
      Il(!0);
      let t = j.state.tokens.length;
      j.state.scopes.push(new Vp.Scope(e, t, !0)), j.state.scopeDepth--;
    }
    ...
    et.parseFunctionBodyAndFinish = Yp;
    function Il(e, t = 0) {
  ...
  var Ji = Z((Je) => {
    ...
    function Ln(e) {
      ...
      G.expect.call(void 0, e || _.TokenType.colon),
        Wt(),
        C.popTypeContext.call(void 0, t);
    }
    function Zp() {
      G.expect.call(void 0, _.TokenType.modulo),
        G.expectContextual.call(void 0, Te.ContextualKeyword._checks),
        C.eat.call(void 0, _.TokenType.parenL) &&
          (je.parseExpression.call(void 0),
          G.expect.call(void 0, _.TokenType.parenR));
    }
    function Pl() {
      let e = C.pushTypeContext.call(void 0, 0);
      G.expect.call(void 0, _.TokenType.colon),
        C.match.call(void 0, _.TokenType.modulo)
          ? Zp()
          : (Wt(), C.match.call(void 0, _.TokenType.modulo) && Zp()),
    ...
    function Gk() {
      C.next.call(void 0),
        ...
        G.expect.call(void 0, _.TokenType.parenL),
        Al(),
        G.expect.call(void 0, _.TokenType.parenR),
        Pl(),
        G.semicolon.call(void 0);
    }
    function El() {
      C.match.call(void 0, _.TokenType._class)
        ...
        ? zk()
        : G.eatContextual.call(void 0, Te.ContextualKeyword._module)
        ? C.eat.call(void 0, _.TokenType.dot)
          ? Jk()
          : Xk()
        : G.isContextual.call(void 0, Te.ContextualKeyword._type)
        ? Qk()
        : G.isContextual.call(void 0, Te.ContextualKeyword._opaque)
        ? Zk()
        : G.isContextual.call(void 0, Te.ContextualKeyword._interface)
        ? e0()
        : C.match.call(void 0, _.TokenType._export)
        ? Yk()
        : G.unexpected.call(void 0);
    }
    function zk() {
      C.next.call(void 0), rh(), G.semicolon.call(void 0);
    }
    function Xk() {
      for (
        C.match.call(void 0, _.TokenType.string)
          ...
          : je.parseIdentifier.call(void 0),
          G.expect.call(void 0, _.TokenType.braceL);
        ...
        C.match.call(void 0, _.TokenType._import)
          ...
          : G.unexpected.call(void 0);
      G.expect.call(void 0, _.TokenType.braceR);
    }
    function Yk() {
      G.expect.call(void 0, _.TokenType._export),
        C.eat.call(void 0, _.TokenType._default)
          ? C.match.call(void 0, _.TokenType._function) ||
            C.match.call(void 0, _.TokenType._class)
            ? El()
            : (Wt(), G.semicolon.call(void 0))
          : C.match.call(void 0, _.TokenType._var) ||
            C.match.call(void 0, _.TokenType._function) ||
            C.match.call(void 0, _.TokenType._class) ||
            G.isContextual.call(void 0, Te.ContextualKeyword._opaque)
    ...
    function Jk() {
      G.expectContextual.call(void 0, Te.ContextualKeyword._exports),
        vi(),
        G.semicolon.call(void 0);
    }
    function Qk() {
    ...
    function Nl(e = !1) {
      ...
      if (G.isContextual.call(void 0, Te.ContextualKeyword._mixins)) {
        C.next.call(void 0);
        do bo();
        while (C.eat.call(void 0, _.TokenType.comma));
      }
      if (G.isContextual.call(void 0, Te.ContextualKeyword._implements)) {
        C.next.call(void 0);
        do bo();
        while (C.eat.call(void 0, _.TokenType.comma));
      }
    ...
    function bo() {
      nh(!1), C.match.call(void 0, _.TokenType.lessThan) && Rs();
    }
    function Rl() {
      Nl();
    }
    ...
    function Ol(e) {
      G.expectContextual.call(void 0, Te.ContextualKeyword._type),
        So(),
        C.match.call(void 0, _.TokenType.lessThan) && On(),
    ...
    function t0() {
      Fl(), rh(), C.eat.call(void 0, _.TokenType.eq) && Wt();
    }
    function On() {
      let e = C.pushTypeContext.call(void 0, 0);
      ...
      do
        t0(),
          C.match.call(void 0, _.TokenType.greaterThan) ||
            G.expect.call(void 0, _.TokenType.comma);
      while (!C.match.call(void 0, _.TokenType.greaterThan) && !ue.state.error);
      G.expect.call(void 0, _.TokenType.greaterThan),
        C.popTypeContext.call(void 0, e);
    }
    ...
    function Rs() {
      let e = C.pushTypeContext.call(void 0, 0);
      for (
        G.expect.call(void 0, _.TokenType.lessThan);
    ...
    function n0() {
      if (
        (G.expectContextual.call(void 0, Te.ContextualKeyword._interface),
        C.eat.call(void 0, _.TokenType._extends))
      )
        do bo();
        while (C.eat.call(void 0, _.TokenType.comma));
    ...
    function s0() {
      C.lookaheadType.call(void 0) === _.TokenType.colon ? (Dl(), Ln()) : Wt(),
        G.expect.call(void 0, _.TokenType.bracketR),
        Ln();
    }
    function i0() {
      Dl(),
    ...
    function Co(e, t, s) {
      ...
      for (
        t && C.match.call(void 0, _.TokenType.braceBarL)
          ? (G.expect.call(void 0, _.TokenType.braceBarL),
        ...
        if (s && G.isContextual.call(void 0, Te.ContextualKeyword._proto)) {
          let r = C.lookaheadType.call(void 0);
          r !== _.TokenType.colon &&
            r !== _.TokenType.question &&
            (C.next.call(void 0), (e = !1));
        }
        if (e && G.isContextual.call(void 0, Te.ContextualKeyword._static)) {
          let r = C.lookaheadType.call(void 0);
          r !== _.TokenType.colon &&
            r !== _.TokenType.question &&
            C.next.call(void 0);
        ...
        if ((Fl(), C.eat.call(void 0, _.TokenType.bracketL)))
          C.eat.call(void 0, _.TokenType.bracketL) ? i0() : s0();
        else if (
          C.match.call(void 0, _.TokenType.parenL) ||
          C.match.call(void 0, _.TokenType.lessThan)
        )
          ...
          if (
            G.isContextual.call(void 0, Te.ContextualKeyword._get) ||
            G.isContextual.call(void 0, Te.ContextualKeyword._set)
          ) {
            let r = C.lookaheadType.call(void 0);
            (r === _.TokenType.name ||
      ...
      G.expect.call(void 0, i);
    }
    function o0() {
      if (C.match.call(void 0, _.TokenType.ellipsis)) {
        if (
          (G.expect.call(void 0, _.TokenType.ellipsis),
    ...
    function l0() {
      nh(!0), C.match.call(void 0, _.TokenType.lessThan) && Rs();
    }
    function c0() {
      G.expect.call(void 0, _.TokenType._typeof), sh();
    }
    function u0() {
      for (
        G.expect.call(void 0, _.TokenType.bracketL);
    ...
    function sh() {
      ...
      switch (ue.state.type) {
        case _.TokenType.name: {
          if (G.isContextual.call(void 0, Te.ContextualKeyword._interface)) {
            n0();
            return;
          }
          je.parseIdentifier.call(void 0), l0();
          return;
        }
        ...
        case _.TokenType.lessThan:
          On(),
            ...
            Al(),
            G.expect.call(void 0, _.TokenType.parenR),
            G.expect.call(void 0, _.TokenType.arrow),
            Wt();
          return;
    ...
    function p0() {
      for (
        sh();
        !G.canInsertSemicolon.call(void 0) &&
        ...
        C.eat.call(void 0, _.TokenType.questionDot),
          ...
          C.eat.call(void 0, _.TokenType.bracketR) ||
            (Wt(), G.expect.call(void 0, _.TokenType.bracketR));
    }
    function ih() {
      C.eat.call(void 0, _.TokenType.question) ? ih() : p0();
    }
    function eh() {
      ih(),
        !ue.state.noAnonFunctionType &&
    ...
    function th() {
      for (
        C.eat.call(void 0, _.TokenType.bitwiseAND), eh();
    ...
    function h0() {
      for (
        C.eat.call(void 0, _.TokenType.bitwiseOR), th();
    ...
    Je.flowParseFunctionBodyAndFinish = f0;
    function d0(e, t, s) {
      if (
        C.match.call(void 0, _.TokenType.questionDot) &&
    ...
    Je.flowStartParseNewArguments = m0;
    function T0() {
      if (
        C.match.call(void 0, _.TokenType.name) &&
        ue.state.contextualKeyword === Te.ContextualKeyword._interface
      ) {
        let e = C.pushTypeContext.call(void 0, 0);
        return C.next.call(void 0), Rl(), C.popTypeContext.call(void 0, e), !0;
      } else if (G.isContextual.call(void 0, Te.ContextualKeyword._enum))
        return oh(), !0;
      return !1;
    }
    Je.flowTryParseStatement = T0;
    function y0() {
      return G.isContextual.call(void 0, Te.ContextualKeyword._enum)
        ? (oh(), !0)
        : !1;
    }
    Je.flowTryParseExportDefaultExpression = y0;
    function k0(e) {
    ...
    Je.flowParseIdentifierStatement = k0;
    function v0() {
      return (
        G.isContextual.call(void 0, Te.ContextualKeyword._type) ||
        G.isContextual.call(void 0, Te.ContextualKeyword._interface) ||
        G.isContextual.call(void 0, Te.ContextualKeyword._opaque) ||
        G.isContextual.call(void 0, Te.ContextualKeyword._enum)
      );
    }
    Je.flowShouldParseExportDeclaration = v0;
    function x0() {
      return (
        C.match.call(void 0, _.TokenType.name) &&
        (ue.state.contextualKeyword === Te.ContextualKeyword._type ||
          ue.state.contextualKeyword === Te.ContextualKeyword._interface ||
          ue.state.contextualKeyword === Te.ContextualKeyword._opaque ||
          ue.state.contextualKeyword === Te.ContextualKeyword._enum)
      );
    }
    Je.flowShouldDisallowExportDefaultSpecifier = x0;
    function g0() {
      if (G.isContextual.call(void 0, Te.ContextualKeyword._type)) {
        ...
        C.next.call(void 0),
          C.match.call(void 0, _.TokenType.braceL)
            ...
            : Ll(),
          C.popTypeContext.call(void 0, e);
      } else if (G.isContextual.call(void 0, Te.ContextualKeyword._opaque)) {
        let e = C.pushTypeContext.call(void 0, 1);
        C.next.call(void 0), Ol(!1), C.popTypeContext.call(void 0, e);
      } else if (G.isContextual.call(void 0, Te.ContextualKeyword._interface)) {
        let e = C.pushTypeContext.call(void 0, 1);
        C.next.call(void 0), Rl(), C.popTypeContext.call(void 0, e);
      } else Ts.parseStatement.call(void 0, !0);
    }
    Je.flowParseExportDeclaration = g0;
    function _0() {
      return (
        C.match.call(void 0, _.TokenType.star) ||
        (G.isContextual.call(void 0, Te.ContextualKeyword._type) &&
    ...
    Je.flowShouldParseExportStar = _0;
    function b0() {
      if (G.eatContextual.call(void 0, Te.ContextualKeyword._type)) {
    ...
    Je.flowParseExportStar = b0;
    function C0(e) {
      if (
        (e && C.match.call(void 0, _.TokenType.lessThan) && Rs(),
        G.isContextual.call(void 0, Te.ContextualKeyword._implements))
      ) {
        let t = C.pushTypeContext.call(void 0, 0);
        C.next.call(void 0),
          (ue.state.tokens[ue.state.tokens.length - 1].type =
    ...
    Je.flowAfterParseClassSuper = C0;
    function w0() {
      C.match.call(void 0, _.TokenType.lessThan) &&
        (On(),
        C.match.call(void 0, _.TokenType.parenL) || G.unexpected.call(void 0));
    }
    Je.flowStartParseObjPropValue = w0;
    function S0() {
      let e = C.pushTypeContext.call(void 0, 0);
      C.eat.call(void 0, _.TokenType.question),
        C.match.call(void 0, _.TokenType.colon) && vi(),
    ...
    Je.flowParseAssignableListItemTypes = S0;
    function I0() {
      if (
    ...
    Je.flowStartParseImportSpecifiers = I0;
    function E0() {
      let e =
        ue.state.contextualKeyword === Te.ContextualKeyword._type ||
        ue.state.type === _.TokenType._typeof;
      e ? C.next.call(void 0) : je.parseIdentifier.call(void 0),
        G.isContextual.call(void 0, Te.ContextualKeyword._as) &&
        !G.isLookaheadContextual.call(void 0, Te.ContextualKeyword._as)
          ? (je.parseIdentifier.call(void 0),
            (e &&
              !C.match.call(void 0, _.TokenType.name) &&
          ...
          : (e &&
              (C.match.call(void 0, _.TokenType.name) ||
                ue.state.type & _.TokenType.IS_KEYWORD) &&
              je.parseIdentifier.call(void 0),
            G.eatContextual.call(void 0, Te.ContextualKeyword._as) &&
              je.parseIdentifier.call(void 0));
    }
    Je.flowParseImportSpecifier = E0;
    function A0() {
      if (C.match.call(void 0, _.TokenType.lessThan)) {
        let e = C.pushTypeContext.call(void 0, 0);
    ...
    Je.flowStartParseFunctionParams = A0;
    function P0() {
      C.match.call(void 0, _.TokenType.colon) && vi();
    }
    Je.flowAfterParseVarHead = P0;
    function N0() {
    ...
    Je.flowStartParseAsyncArrowFromCallExpression = N0;
    function R0(e, t) {
      if (C.match.call(void 0, _.TokenType.lessThan)) {
    ...
    function L0() {
      if (C.match.call(void 0, _.TokenType.colon)) {
        ...
        (ue.state.noAnonFunctionType = !0),
          ...
          G.canInsertSemicolon.call(void 0) && G.unexpected.call(void 0),
          C.match.call(void 0, _.TokenType.arrow) || G.unexpected.call(void 0),
          ue.state.error && ue.state.restoreFromSnapshot(t),
          C.popTypeContext.call(void 0, e);
      }
      return C.eat.call(void 0, _.TokenType.arrow);
    }
    Je.flowParseArrow = L0;
    function O0(e, t = !1) {
      if (
        ...
        let s = ue.state.snapshot();
        if (D0() && !ue.state.error) return;
        ue.state.restoreFromSnapshot(s);
      }
      je.baseParseSubscripts.call(void 0, e, t);
    }
    Je.flowParseSubscripts = O0;
    function D0() {
      ue.state.scopeDepth++;
    ...
    function oh() {
      G.expectContextual.call(void 0, Te.ContextualKeyword._enum),
        (ue.state.tokens[ue.state.tokens.length - 1].type = _.TokenType._enum),
        je.parseIdentifier.call(void 0),
        M0();
    }
    function M0() {
      G.eatContextual.call(void 0, Te.ContextualKeyword._of) &&
        C.next.call(void 0),
        G.expect.call(void 0, _.TokenType.braceL),
        F0(),
        G.expect.call(void 0, _.TokenType.braceR);
  ...
  var nr = Z((yt) => {
    ...
    function j0() {
      if (
        (ql(O.TokenType.eof),
        P.state.scopes.push(new ys.Scope(0, P.state.tokens.length, !0)),
        P.state.scopeDepth !== 0)
      )
        throw new Error(
          `Invalid scope depth at end of file: ${P.state.scopeDepth}`
        );
      return new V0.File(P.state.tokens, P.state.scopes);
    }
    yt.parseTopLevel = j0;
    function _n(e) {
      (P.isFlowEnabled && Ft.flowTryParseStatement.call(void 0)) ||
        ($.match.call(void 0, O.TokenType.at) && $l(), $0(e));
    }
    yt.parseStatement = _n;
    function $0(e) {
      if (P.isTypeScriptEnabled && dt.tsTryParseStatementContent.call(void 0))
        return;
      let t = P.state.type;
      switch (t) {
        case O.TokenType._break:
        case O.TokenType._continue:
          K0();
          return;
        case O.TokenType._debugger:
          U0();
          return;
        case O.TokenType._do:
          H0();
          return;
        case O.TokenType._for:
          W0();
          return;
        case O.TokenType._function:
          if ($.lookaheadType.call(void 0) === O.TokenType.dot) break;
          e || ee.unexpected.call(void 0), X0();
          return;
        case O.TokenType._class:
          e || ee.unexpected.call(void 0), Io(!0);
          return;
        case O.TokenType._if:
          Y0();
          return;
        case O.TokenType._return:
          J0();
          return;
        case O.TokenType._switch:
          Q0();
          return;
        case O.TokenType._throw:
          Z0();
          return;
        case O.TokenType._try:
          tv();
          return;
        case O.TokenType._let:
        case O.TokenType._const:
          e || ee.unexpected.call(void 0);
        case O.TokenType._var:
          Vl(t !== O.TokenType._var);
          return;
        case O.TokenType._while:
          nv();
          return;
        case O.TokenType.braceL:
          gi();
          return;
        case O.TokenType.semi:
          sv();
          return;
        case O.TokenType._export:
        case O.TokenType._import: {
          let r = $.lookaheadType.call(void 0);
          if (r === O.TokenType.parenL || r === O.TokenType.dot) break;
          $.next.call(void 0), t === O.TokenType._import ? vh() : Th();
          return;
        }
        case O.TokenType.name:
          if (P.state.contextualKeyword === ke.ContextualKeyword._async) {
            let r = P.state.start,
              a = P.state.snapshot();
            if (
              ($.next.call(void 0),
              $.match.call(void 0, O.TokenType._function) &&
                !ee.canInsertSemicolon.call(void 0))
            ) {
              ee.expect.call(void 0, O.TokenType._function), lr(r, !0);
              return;
            ...
            $.lookaheadType.call(void 0) === O.TokenType.name
          ) {
            Vl(!0);
            return;
          }
      ...
      if (P.state.tokens.length === s + 1) {
        ...
        r.type === O.TokenType.name && (i = r.contextualKeyword);
      }
      if (i == null) {
        ee.semicolon.call(void 0);
        return;
      }
      $.eat.call(void 0, O.TokenType.colon) ? iv() : rv(i);
    }
    function $l() {
      for (; $.match.call(void 0, O.TokenType.at); ) uh();
    }
    yt.parseDecorators = $l;
    function uh() {
      if (($.next.call(void 0), $.eat.call(void 0, O.TokenType.parenL)))
        De.parseExpression.call(void 0),
          ee.expect.call(void 0, O.TokenType.parenR);
      else {
        for (
          De.parseIdentifier.call(void 0);
          $.eat.call(void 0, O.TokenType.dot);
    ...
    function ph() {
      $.eat.call(void 0, O.TokenType.parenL) &&
        De.parseCallExpressionArguments.call(void 0);
    }
    yt.baseParseMaybeDecoratorArguments = ph;
    function K0() {
      $.next.call(void 0),
    ...
    function H0() {
      $.next.call(void 0),
        _n(!1),
        ee.expect.call(void 0, O.TokenType._while),
        De.parseParenExpression.call(void 0),
        $.eat.call(void 0, O.TokenType.semi);
    }
    function W0() {
      P.state.scopeDepth++;
      ...
      P.state.scopes.push(new ys.Scope(e, t, !1)), P.state.scopeDepth--;
    }
    function G0() {
      return !(
    ...
    function z0() {
      ...
      if (
        ...
        ee.expect.call(void 0, O.TokenType.parenL),
        $.match.call(void 0, O.TokenType.semi))
      ) {
        e && ee.unexpected.call(void 0), Bl();
        return;
      }
      if (
        $.match.call(void 0, O.TokenType._var) ||
        $.match.call(void 0, O.TokenType._let) ||
        $.match.call(void 0, O.TokenType._const) ||
        G0()
      ) {
        if (
          ($.next.call(void 0),
          hh(!0, P.state.type !== O.TokenType._var),
          $.match.call(void 0, O.TokenType._in) ||
    ...
    function Y0() {
      $.next.call(void 0),
        De.parseParenExpression.call(void 0),
        _n(!1),
        $.eat.call(void 0, O.TokenType._else) && _n(!1);
    }
    function J0() {
      $.next.call(void 0),
        ee.isLineTerminator.call(void 0) ||
    ...
    function Q0() {
      ...
      let e = P.state.tokens.length;
      for (
        ee.expect.call(void 0, O.TokenType.braceL);
        !$.match.call(void 0, O.TokenType.braceR) && !P.state.error;

      )
        if (
          $.match.call(void 0, O.TokenType._case) ||
          $.match.call(void 0, O.TokenType._default)
        ) {
          let s = $.match.call(void 0, O.TokenType._case);
          $.next.call(void 0),
            s && De.parseExpression.call(void 0),
            ee.expect.call(void 0, O.TokenType.colon);
        } else _n(!0);
      $.next.call(void 0);
      let t = P.state.tokens.length;
      P.state.scopes.push(new ys.Scope(e, t, !1)), P.state.scopeDepth--;
    ...
    function tv() {
      if (
        ...
        let e = null;
        if (
          ($.match.call(void 0, O.TokenType.parenL) &&
            (P.state.scopeDepth++,
      ...
      $.eat.call(void 0, O.TokenType._finally) && gi();
    }
    function Vl(e) {
      $.next.call(void 0), hh(!1, e), ee.semicolon.call(void 0);
    }
    yt.parseVarStatement = Vl;
    function nv() {
    ...
    function gi(e = !1, t = 0) {
      ...
      P.state.scopeDepth++,
        ...
        ql(O.TokenType.braceR),
        t && (P.state.tokens[P.state.tokens.length - 1].contextId = t);
      let i = P.state.tokens.length;
      P.state.scopes.push(new ys.Scope(s, i, e)), P.state.scopeDepth--;
    }
    yt.parseBlock = gi;
    function ql(e) {
      for (; !$.eat.call(void 0, e) && !P.state.error; ) _n(!0);
    }
    yt.parseBlockBody = ql;
    function Bl() {
      ee.expect.call(void 0, O.TokenType.semi),
        $.match.call(void 0, O.TokenType.semi) ||
          De.parseExpression.call(void 0),
        ee.expect.call(void 0, O.TokenType.semi),
        $.match.call(void 0, O.TokenType.parenR) ||
          De.parseExpression.call(void 0),
        ee.expect.call(void 0, O.TokenType.parenR),
        _n(!1);
    }
    ...
    function lr(e, t, s = !1) {
      $.match.call(void 0, O.TokenType.star) && $.next.call(void 0),
        t &&
          !s &&
          !$.match.call(void 0, O.TokenType.name) &&
          !$.match.call(void 0, O.TokenType._yield) &&
      ...
      P.state.scopeDepth++, fh(), De.parseFunctionBodyAndFinish.call(void 0, e);
      let a = P.state.tokens.length;
      P.state.scopes.push(new ys.Scope(r, a, !0)),
        P.state.scopeDepth--,
        i !== null &&
          (P.state.scopes.push(new ys.Scope(i, a, !0)), P.state.scopeDepth--);
    }
    yt.parseFunction = lr;
    function fh(e = !1, t = 0) {
      P.isTypeScriptEnabled
        ...
        ee.expect.call(void 0, O.TokenType.parenL),
        t && (P.state.tokens[P.state.tokens.length - 1].contextId = t),
        ks.parseBindingList.call(void 0, O.TokenType.parenR, !1, !1, e, t),
        t && (P.state.tokens[P.state.tokens.length - 1].contextId = t);
    }
    yt.parseFunctionParams = fh;
    function Io(e, t = !1) {
      ...
      let i = null;
      e || ((i = P.state.tokens.length), P.state.scopeDepth++), uv(e, t), pv();
      let r = P.state.tokens.length;
      if (
        (av(s),
        !P.state.error &&
        ...
        let a = P.state.tokens.length;
        P.state.scopes.push(new ys.Scope(i, a, !1)), P.state.scopeDepth--;
      }
    }
    yt.parseClass = Io;
    function dh() {
      return (
        $.match.call(void 0, O.TokenType.eq) ||
        $.match.call(void 0, O.TokenType.semi) ||
        $.match.call(void 0, O.TokenType.braceR) ||
        $.match.call(void 0, O.TokenType.bang) ||
        $.match.call(void 0, O.TokenType.colon)
      );
    }
    function mh() {
      return (
        $.match.call(void 0, O.TokenType.parenL) ||
        $.match.call(void 0, O.TokenType.lessThan)
      );
    }
    function av(e) {
      for (
        ee.expect.call(void 0, O.TokenType.braceL);
        !$.eat.call(void 0, O.TokenType.braceR) && !P.state.error;

      ) {
        if ($.eat.call(void 0, O.TokenType.semi)) continue;
        if ($.match.call(void 0, O.TokenType.at)) {
          uh();
          continue;
        }
        let t = P.state.start;
    ...
    function lv(e, t) {
      ...
      if (
        ...
        if ((De.parseIdentifier.call(void 0), mh())) {
          or(e, !1);
          return;
        } else if (dh()) {
          ar();
        ...
        if (
          ((P.state.tokens[P.state.tokens.length - 1].type =
            O.TokenType._static),
          (s = !0),
          $.match.call(void 0, O.TokenType.braceL))
        ) {
    ...
    function cv(e, t, s) {
      if (
        ...
        return;
      if ($.eat.call(void 0, O.TokenType.star)) {
        xi(s), or(e, !1);
        return;
      }
      xi(s);
      ...
      r.contextualKeyword === ke.ContextualKeyword._constructor && (i = !0),
        ...
        mh()
          ...
          : (r.contextualKeyword === ke.ContextualKeyword._get ||
            ...
            !(
              ee.isLineTerminator.call(void 0) &&
              $.match.call(void 0, O.TokenType.star)
            )
          ? (r.contextualKeyword === ke.ContextualKeyword._get
              ? (P.state.tokens[P.state.tokens.length - 1].type =
                  O.TokenType._get)
    ...
    yt.parseClassPropertyName = xi;
    function jl() {
      if (P.isTypeScriptEnabled) {
        let e = $.pushTypeContext.call(void 0, 0);
        $.eat.call(void 0, O.TokenType.question),
          $.popTypeContext.call(void 0, e);
      }
    }
    yt.parsePostMemberNameModifiers = jl;
    function ar() {
      if (
        (P.isTypeScriptEnabled
          ? ($.eatTypeToken.call(void 0, O.TokenType.bang),
    ...
    function pv() {
      let e = !1;
      $.eat.call(void 0, O.TokenType._extends)
    ...
    function Th() {
      ...
      (P.isTypeScriptEnabled && dt.tsTryParseExport.call(void 0)) ||
        (mv()
          ...
          : dv()
          ? (De.parseIdentifier.call(void 0),
            $.match.call(void 0, O.TokenType.comma) &&
            $.lookaheadType.call(void 0) === O.TokenType.star
              ? (ee.expect.call(void 0, O.TokenType.comma),
                ee.expect.call(void 0, O.TokenType.star),
                ee.expectContextual.call(void 0, ke.ContextualKeyword._as),
                De.parseIdentifier.call(void 0))
              : yh(),
            cr())
          : $.eat.call(void 0, O.TokenType._default)
          ? hv()
          : kv()
          ? fv()
          : (Kl(), cr()),
    ...
    function hv() {
      if (
        ...
        return;
      let e = P.state.start;
      $.eat.call(void 0, O.TokenType._function)
        ? lr(e, !0, !0)
        : ee.isContextual.call(void 0, ke.ContextualKeyword._async) &&
          $.lookaheadType.call(void 0) === O.TokenType._function
        ? (ee.eatContextual.call(void 0, ke.ContextualKeyword._async),
          $.eat.call(void 0, O.TokenType._function),
          lr(e, !0, !0))
        : $.match.call(void 0, O.TokenType._class)
        ? Io(!0, !0)
        : $.match.call(void 0, O.TokenType.at)
        ? ($l(), Io(!0, !0))
    ...
    function Tv() {
      P.isFlowEnabled ? Ft.flowParseExportStar.call(void 0) : kh();
    }
    function kh() {
      ee.expect.call(void 0, O.TokenType.star),
        ee.isContextual.call(void 0, ke.ContextualKeyword._as) ? yv() : cr();
    }
    yt.baseParseExportStar = kh;
    function yv() {
      $.next.call(void 0),
        (P.state.tokens[P.state.tokens.length - 1].type = O.TokenType._as),
        De.parseIdentifier.call(void 0),
        yh(),
        cr();
    }
    function kv() {
      return (
        ...
        P.state.type === O.TokenType._var ||
        P.state.type === O.TokenType._const ||
        P.state.type === O.TokenType._let ||
        P.state.type === O.TokenType._function ||
        P.state.type === O.TokenType._class ||
        ee.isContextual.call(void 0, ke.ContextualKeyword._async) ||
        $.match.call(void 0, O.TokenType.at)
      );
    }
    function Kl() {
      ...
      for (
        ...
        if (e) e = !1;
          ...
          (ee.expect.call(void 0, O.TokenType.comma),
          $.eat.call(void 0, O.TokenType.braceR))
        )
          break;
        vv();
      }
    }
    yt.parseExportSpecifiers = Kl;
    function vv() {
      if (P.isTypeScriptEnabled) {
    ...
    function vh() {
      if (
        P.isTypeScriptEnabled &&
        $.match.call(void 0, O.TokenType.name) &&
        $.lookaheadType.call(void 0) === O.TokenType.eq
      ) {
      ...
      if (
        ...
        if (
          ...
          (e.type === O.TokenType.star || e.type === O.TokenType.braceL) &&
            ee.expectContextual.call(void 0, ke.ContextualKeyword._type);
      }
      $.match.call(void 0, O.TokenType.string) ||
        (gv(),
        bv(),
    ...
    yt.parseImport = vh;
    function _v() {
      return $.match.call(void 0, O.TokenType.name);
    }
    function ch() {
    ...
    function bv() {
      ...
      let e = !0;
      if (!(_v() && (ch(), !$.eat.call(void 0, O.TokenType.comma)))) {
        if ($.match.call(void 0, O.TokenType.star)) {
          $.next.call(void 0),
            ee.expectContextual.call(void 0, ke.ContextualKeyword._as),
            ch();
          return;
        ...
        for (
          ...
          if (e) e = !1;
            ...
            ($.eat.call(void 0, O.TokenType.colon) &&
              ee.unexpected.call(
                void 0,
  ...
  var bh = Z((Wl) => {
    ...
    function Sv() {
      return (
        Hl.state.pos === 0 &&
          Hl.input.charCodeAt(0) === _h.charCodes.numberSign &&
          Hl.input.charCodeAt(1) === _h.charCodes.exclamationMark &&
          gh.skipLineComment.call(void 0, 2),
        gh.nextToken.call(void 0),
        wv.parseTopLevel.call(void 0)
      );
    }
    Wl.parseFile = Sv;
  });
  var Ul = Z((Ao) => {
    ...
    function Ev(e, t, s, i) {
      ...
      let r = Iv.parseFile.call(void 0);
    ...
    function Pv(e) {
      ...
      do {
        ...
        if (
          ...
          r.contextualKeyword === Av.ContextualKeyword._await &&
        ...
        appendTokenPrefix() {
          ...
          if (
            ((t.numNullishCoalesceStarts || t.isOptionalChainStart) &&
              (t.isAsyncOperation = Lv.default.call(void 0, this)),
  ...
  var Eh = Z((Ql) => {
    ...
    function Ov(e, t, s, i) {
      ...
      for (t.nextToken(); !t.matchesContextIdAndLabel(Ne.TokenType.braceR, f); )
        if (
          t.matchesContextual(Sh.ContextualKeyword._constructor) &&
          !t.currentToken().isType
        )
          ({constructorInitializerStatements: p, constructorInsertPos: k} =
            Ih(t));
          ...
          let x = t.currentIndex(),
            g = !1,
            S = !1,
            E = !1;
          for (; No(t.currentToken()); )
            t.matches1(Ne.TokenType._static) && (g = !0),
              t.matches1(Ne.TokenType.hash) && (S = !0),
              (t.matches1(Ne.TokenType._declare) ||
                t.matches1(Ne.TokenType._abstract)) &&
                (E = !0),
              t.nextToken();
          if (g && t.matches1(Ne.TokenType.braceL)) {
            Jl(t, f);
            continue;
          }
          if (S) {
          ...
          if (t.matches1(Ne.TokenType.eq)) {
            let H = t.currentIndex(),
              D = t.currentToken().rhsEndIndex;
            if (D == null)
              throw new Error(
                'Expected rhsEndIndex on class field assignment.'
              );
            for (t.nextToken(); t.currentIndex() < D; ) e.processToken();
            let c;
            g
          ...
          } else (!i || E) && u.push({start: x, end: t.currentIndex()});
        }
      return (
  ...
  var ec = Z((Zl) => {
    ...
    function Fv(e) {
      if (
        ...
        e.removeToken(),
        e.removeToken(),
        e.matches1(Ah.TokenType.parenL))
      )
        e.removeToken(), e.removeToken(), e.removeToken();
      else
        for (; e.matches1(Ah.TokenType.dot); ) e.removeToken(), e.removeToken();
    }
    Zl.default = Fv;
  });
  var tc = Z((Ro) => {
    ...
    var Bv = xt(),
      Vv = be(),
      jv = {typeDeclarations: new Set(), valueDeclarations: new Set()};
    Ro.EMPTY_DECLARATION_INFO = jv;
    function $v(e) {
      let t = new Set(),
        s = new Set();
      for (let i = 0; i < e.tokens.length; i++) {
        let r = e.tokens[i];
        r.type === Vv.TokenType.name &&
          Bv.isTopLevelDeclaration.call(void 0, r) &&
          (r.isType
  ...
  var sc = Z((nc) => {
    ...
    var qv = It(),
      Ph = be();
    function Kv(e) {
      e.matches2(Ph.TokenType.name, Ph.TokenType.braceL) &&
        e.matchesContextual(qv.ContextualKeyword._assert) &&
        (e.removeToken(),
        e.removeToken(),
        e.removeBalancedCode(),
        e.removeToken());
    }
    nc.removeMaybeImportAssertion = Kv;
  });
  var rc = Z((ic) => {
    'use strict';
    ...
    function Uv(e, t, s) {
      ...
      if (
        r !== 3 &&
        !(r === 4 && t.matches1AtIndex(i.rhsEndIndex - 1, Nh.TokenType.semi))
      )
        return !1;
      let a = t.tokenAtRelativeIndex(2);
      if (a.type !== Nh.TokenType.name) return !1;
  ...
  var Lh = Z((ac) => {
    ...
    var Lo = xt(),
      ...
      oc = class e extends Zv.default {
        ...
        constructor(t, s, i, r, a, p, d, y, k, A) {
          super(),
            (this.rootTransformer = t),
            (this.tokens = s),
            (this.importProcessor = i),
            ...
            (this.preserveDynamicImport = A),
            e.prototype.__init.call(this),
            e.prototype.__init2.call(this),
            e.prototype.__init3.call(this),
            (this.declarationInfo = k
              ? Gv.default.call(void 0, s)
              : Rh.EMPTY_DECLARATION_INFO);
        }
        getPrefixCode() {
          let t = '';
          return (
...
`
        ...
        processImportEquals() {
          ...
          return (
            this.importProcessor.isTypeName(t)
              ? Wv.default.call(void 0, this.tokens)
        ...
        processExportBindings() {
          ...
          for (;;) {
            ...
            let s = Xv.default.call(void 0, this.tokens);
    ...
    var Jn = It(),
      ...
      lc = class extends lx.default {
        constructor(t, s, i, r, a, p) {
          super(),
            ...
            (this.nonTypeIdentifiers = a
              ? ix.getNonTypeIdentifiers.call(void 0, t, p)
              : new Set()),
            (this.declarationInfo = a
              ? nx.default.call(void 0, t)
              : Mh.EMPTY_DECLARATION_INFO),
          ...
          if (
            ...
            return (
              this.tokens.matchesContextual(Jn.ContextualKeyword._from) &&
                ...
                (this.tokens.removeToken(),
                this.tokens.removeToken(),
                Dh.removeMaybeImportAssertion.call(void 0, this.tokens)),
              !0
            );
          }
          return !1;
        ...
        processImportEquals() {
          ...
          return (
            this.isTypeName(t)
              ? tx.default.call(void 0, this.tokens)
              : this.injectCreateRequireForImportRequire
              ? (this.tokens.replaceToken('const'),
                this.tokens.copyToken(),
                this.tokens.copyToken(),
        ...
        removeImportTypeBindings() {
          ...
          if (
            ...
            for (
              ...
              let i = Oh.default.call(void 0, this.tokens);
        ...
        processNamedExports() {
          ...
          for (
            ...
            let t = Oh.default.call(void 0, this.tokens);
    ...
    var Bh = It(),
      ...
      uc = class extends px.default {
        ...
        processEnum() {
          ...
          let t = !1;
          this.tokens.matchesContextual(Bh.ContextualKeyword._of) &&
            (this.tokens.removeToken(),
            (t = this.tokens.matchesContextual(Bh.ContextualKeyword._symbol)),
            this.tokens.removeToken());
  ...
  var jh = Z((fc) => {
    ...
    var Qn = be(),
      ...
      mx = hx(dx),
      Do = 'jest',
      Tx = ['mock', 'unmock', 'enableAutomock', 'disableAutomock'],
      hc = class e extends mx.default {
        __init() {
  ...
  var $h = Z((mc) => {
    ...
    var kx = be(),
      vx = hn(),
      xx = yx(vx),
      dc = class extends xx.default {
        constructor(t) {
          super(), (this.tokens = t);
        }
        process() {
          if (this.tokens.matches1(kx.TokenType.num)) {
  ...
  var Kh = Z((yc) => {
    ...
    var qh = be(),
      _x = hn(),
      bx = gx(_x),
      Tc = class extends bx.default {
        constructor(t, s) {
          super(), (this.tokens = t), (this.nameManager = s);
        }
        process() {
          return this.tokens.matches2(qh.TokenType._catch, qh.TokenType.braceL)
            ? (this.tokens.copyToken(),
              this.tokens.appendCode(
      ...
      (function () {
        ...
        getSuffixCode() {
          ...
          for (let i of this.tokens.tokens)
            !i.isType &&
              Gh.isTopLevelDeclaration.call(void 0, i) &&
              i.identifierRole !== Gh.IdentifierRole.ImportDeclaration &&
...
`)}
  ...
  var Yh = Z((Cc) => {
    ...
    function Ox(e) {
      if (e.length === 0 || !Xh.IS_IDENTIFIER_START[e.charCodeAt(0)]) return !1;
      for (let t = 1; t < e.length; t++)
        if (!Xh.IS_IDENTIFIER_CHAR[e.charCodeAt(t)]) return !1;
      return !Lx.has(e);
    }
    Cc.default = Ox;
  });
      ...
      wc = class extends Fx.default {
        ...
        extractEnumKeyInfo(t) {
          if (t.type === $e.TokenType.name) {
            ...
            return {
              nameStringCode: `"${s}"`,
              variableName: Jh.default.call(void 0, s) ? s : null,
            };
        ...
        constructor(t, s, i, r) {
          ...
          (this.tokens = a),
            ...
            r.disableESTransforms ||
              ...
              this.transformers.push(new Qx.default(a)),
              this.transformers.push(new eg.default(a, this.nameManager))),
            s.includes('jsx') &&
              (r.jsxRuntime !== 'preserve' &&
                this.transformers.push(
                  new Yx.default(this, a, p, this.nameManager, r)
                ),
              this.transformers.push(new ig.default(this, a, p, r)));
          let d = null;
          if (s.includes('react-hot-loader')) {
            ...
            (d = new og.default(a, r.filePath)), this.transformers.push(d);
          }
          ...
          s.includes('flow') &&
            this.transformers.push(
              new Wx.default(this, a, s.includes('imports'))
            ),
            s.includes('typescript') &&
              this.transformers.push(
            ...
            s.includes('jest') &&
              this.transformers.push(
                new zx.default(this, a, this.nameManager, p)
              );
        }
        transform() {
...
`)),
        ...
        processClassBody(t, s) {
          ...
          if (r === null && f) {
            let x = this.makeConstructorInitCode(a, d, s);
            if (i.hasSuperclass) {
              let g = this.nameManager.claimFreeName('args');
              this.tokens.appendCode(
                `constructor(...${g}) { super(...${g}); ${x}; }`
              );
            } else this.tokens.appendCode(`constructor() { ${x}; }`);
          }
          for (
            ;
            !this.tokens.matchesContextIdAndLabel(lt.TokenType.braceR, u);

          )
            if (k < p.length && this.tokens.currentIndex() === p[k].start) {
              let x = !1;
              for (
                this.tokens.matches1(lt.TokenType.bracketL)
                  ? this.tokens.copyTokenWithPrefix(
                      `${p[k].initializerName}() {this`
                    )
                ...
                this.tokens.currentIndex() < p[k].end;

              )
                x &&
                  this.tokens.currentIndex() === p[k].equalsIndex &&
                  this.tokens.appendCode(']'),
                  this.processToken();
              this.tokens.appendCode('}'), k++;
            } else if (
              A < y.length &&
              this.tokens.currentIndex() >= y[A].start
            ) {
              for (
                this.tokens.currentIndex() < y[A].end &&
                this.tokens.removeInitialToken();
                this.tokens.currentIndex() < y[A].end;
        ...
        processPossibleAsyncArrowWithTypeParams() {
          if (
            !this.tokens.matchesContextual(Bx.ContextualKeyword._async) &&
          ...
          for (var s = [0], i = 0; i < t.length; )
            switch (t[i]) {
              case Mo:
                ...
                break;
              case tf:
                (i += tf.length), t[i] === Mo && (i += Mo.length), s.push(i);
                break;
              default:
                i++;
                break;
  ...
  var rf = Z((Ac) => {
    ...
    function fg(e, t) {
      ...
      let s = Object.keys(t[0]).filter(
        ...
        d = r.map(() => 0);
      for (let f of p)
        for (let x = 0; x < f.length; x++) d[x] = Math.max(d[x], f[x].length);
      return p.map((f) => f.map((x, g) => x.padEnd(d[g])).join(' ')).join(`
`);
      function y(f) {
        let x = e.slice(f.start, f.end);
        return [
          A(f.start, f.end),
          hg.formatTokenType.call(void 0, f.type),
          dg(String(x), 14),
          ...s.map((g) => k(f[g], g)),
          ...i.map((g) => k(f.type[g], g)),
        ];
      }
      function k(f, x) {
        return f === !0 ? x : f === !1 || f === null ? '' : String(f);
      }
      function A(f, x) {
        return `${u(f)}-${u(x)}`;
      }
      function u(f) {
        let x = a.locationForIndex(f);
        return x ? `${x.line + 1}:${x.column + 1}` : 'Unknown';
      }
    }
    Ac.default = fg;
    function dg(e, t) {
    ...
    function vg(e, t, s) {
      t++,
        !e.matches1AtIndex(t, Gt.TokenType.parenL) &&
          ...
          e.matches1AtIndex(t, Gt.TokenType.braceL) && (t++, xg(e, t, s)));
    }
    function xg(e, t, s) {
      for (;;) {
        if (e.matches1AtIndex(t, Gt.TokenType.braceR)) return;
        let i = yg.default.call(void 0, e, t);
        if (
          ((t = i.endIndex),
  ...
  var cf = Z((fr) => {
    ...
    fr.getVersion = Vg;
    function jg(e, t) {
      Ag.validateOptions.call(void 0, t);
      try {
        let s = lf(e, t),
          r = new Og.default(
            s,
    ...
    fr.transform = jg;
    function $g(e, t) {
      let s = lf(e, t).tokenProcessor.tokens;
      return Mg.default.call(void 0, e, s);
    }
    fr.getFormattedTokens = $g;
    function lf(e, t) {
      let s = t.transforms.includes('jsx'),
        i = t.transforms.includes('typescript'),
        r = t.transforms.includes('flow'),
        a = t.disableESTransforms === !0,
        p = Pg.parse.call(void 0, e, s, i, r),
        d = p.tokens,
        y = p.scopes,
        k = new Eg.default(e, d),
        A = new wg.HelperManager(k),
        u = new Rg.default(e, d, r, a, A),
      ...
      return (
        t.transforms.includes('imports')
          ? ((x = new _g.default(
            ...
            x.preprocessTokens(),
            af.default.call(void 0, u, y, x.getGlobalNames()),
            t.transforms.includes('typescript') && x.pruneTypeOnlyImports())
          : t.transforms.includes('typescript') &&
            af.default.call(void 0, u, y, Bg.default.call(void 0, u)),
        {
          tokenProcessor: u,
          scopes: y,
          nameManager: k,
    ...
    (function (e, t) {
      ...
      function f(n, o) {
        return n < 65
          ...
          ? !0
          : n <= 65535
          ? n >= 170 && k.test(String.fromCharCode(n))
          : o === !1
          ? !1
          : u(n, s);
      }
      function x(n, o) {
        return n < 48
          ...
          ? !0
          : n <= 65535
          ? n >= 170 && A.test(String.fromCharCode(n))
          : o === !1
          ? !1
          : u(n, s) || u(n, t);
      }
      ...
      function S(n, o) {
        return new g(n, {beforeExpr: !0, binop: o});
      }
      var E = {beforeExpr: !0},
        L = {startsExpr: !0},
        H = {};
      function D(n, o) {
        return o === void 0 && (o = {}), (o.keyword = n), (H[n] = new g(n, o));
      }
      var c = {
          num: new g('num', L),
          regexp: new g('regexp', L),
          string: new g('string', L),
          name: new g('name', L),
          privateId: new g('privateId', L),
          eof: new g('eof'),
          ...
          _default: D('default', E),
          _do: D('do', {isLoop: !0, beforeExpr: !0}),
          _else: D('else', E),
          _finally: D('finally'),
          _for: D('for', {isLoop: !0}),
          _function: D('function', L),
          _if: D('if'),
          _return: D('return', E),
          _switch: D('switch'),
          _throw: D('throw', E),
...
Defaulting to 2020, but this will stop working in the future.`)),
      ...
      function V(n, o) {
        return function (l, h, m, I, R, Y) {
          var Q = {type: l ? 'Block' : 'Line', value: h, start: m, end: I};
          n.locations && (Q.loc = new wt(this, R, Y)),
            n.ranges && (Q.range = [m, I]),
            o.push(Q);
        };
      }
      var W = 1,
      ...
      var pt = 0,
        ...
        Ge = function (o, l, h) {
          ...
          var I = (m ? m + ' ' : '') + a.strict;
          (this.reservedWordsStrict = tt(I)),
            (this.reservedWordsStrictBind = tt(I + ' ' + a.strictBind)),
            (this.input = String(l)),
            (this.containsEsc = !1),
            h
              ? ((this.pos = h),
...
`,
      ...
      (Ge.prototype.parse = function () {
        ...
        (Ge.parseExpressionAt = function (o, l, h) {
      ...
      (te.isLet = function (n) {
        ...
        if (f(h, !0)) {
          for (var m = l + 1; x((h = this.input.charCodeAt(m)), !0); ) ++m;
          if (h === 92 || (h > 55295 && h < 56320)) return !0;
          var I = this.input.slice(l, m);
          if (!y.test(I)) return !0;
        }
        return !1;
      }),
        (te.isAsyncFunction = function () {
          ...
          var n = ae.exec(this.input),
            ...
            l;
          return (
            !M.test(this.input.slice(this.pos, o)) &&
            this.input.slice(o, o + 8) === 'function' &&
            (o + 8 === this.input.length ||
              !(
                x((l = this.input.charCodeAt(o + 8))) ||
                (l > 55295 && l < 56320)
              ))
          );
        }),
        (te.isUsingKeyword = function (n, o) {
          ...
          if (M.test(this.input.slice(this.pos, h))) return !1;
          if (n) {
            var m = h + 5,
              I;
            if (
              ...
              m === this.input.length ||
              x((I = this.input.charCodeAt(m))) ||
              (I > 55295 && I < 56320)
            )
              return !1;
            ae.lastIndex = m;
            var R = ae.exec(this.input);
            if (R && M.test(this.input.slice(m, m + R[0].length))) return !1;
          }
          if (o) {
            var Y = h + 2,
              Q;
            if (
              ...
              (Y === this.input.length ||
                (!x((Q = this.input.charCodeAt(Y))) &&
                  !(Q > 55295 && Q < 56320)))
            )
              return !1;
          }
          var ye = this.input.charCodeAt(h);
          return f(ye, !0) || ye === 92;
        }),
        ...
        (te.parseStatement = function (n, o, l) {
          var h = this.type,
            m = this.startNode(),
            I;
          switch ((this.isLet(n) && ((h = c._var), (I = 'let')), h)) {
            case c._break:
            case c._continue:
            ...
            case c._var:
              return (
                (I = I || this.value),
                n && I !== 'var' && this.unexpected(),
                this.parseVarStatement(m, I)
              );
            case c._while:
      ...
      (te.parseCatchClauseParam = function () {
        ...
        return (
          ...
          this.checkLValPattern(n, o ? bn : Tt),
        ...
        (te.parseLabeledStatement = function (n, o, l, h) {
          for (var m = 0, I = this.labels; m < I.length; m += 1) {
            var R = I[m];
            R.name === o &&
          ...
          for (
            ...
            var ye = this.labels[Q];
            if (ye.statementStart === n.start)
              (ye.statementStart = this.start), (ye.kind = Y);
            else break;
          }
          return (
        ...
        (te.parseVarId = function (n, o) {
          (n.id =
            ...
            this.checkLValPattern(n.id, o === 'var' ? bt : Tt, !1);
        });
      var Mn = 1,
        xs = 2,
        Ds = 4;
      (te.parseFunction = function (n, o, l, h, m) {
        ...
        (te.parseClass = function (n, o) {
          ...
          for (m.body = [], this.expect(c.braceL); this.type !== c.braceR; ) {
            var R = this.parseClassElement(n.superClass !== null);
            R &&
              (m.body.push(R),
          ...
          if (
            ...
            !h &&
              ...
              !this.canInsertSemicolon()
                ? (I = !0)
                : (h = 'async')),
            !h && (o >= 9 || !I) && this.eat(c.star) && (m = !0),
            !h && !I && !m)
          ) {
            var Q = this.value;
            (this.eatContextual('get') || this.eatContextual('set')) &&
              (this.isClassElementNameStart() ? (R = Q) : (h = Q));
          }
          if (
            (h
              ? ((l.computed = !1),
            ...
            o < 13 || this.type === c.parenL || R !== 'method' || m || I)
          ) {
            var ye = !l.static && es(l, 'constructor'),
              xe = ye && n;
            ye &&
              R !== 'method' &&
              this.raise(
              ...
              (l.kind = ye ? 'constructor' : R),
              this.parseClassMethod(l, m, I, xe);
        ...
        (te.parseClassMethod = function (n, o, l, h) {
          ...
          var I = (n.value = this.parseMethod(o, l, h));
          return (
            n.kind === 'get' &&
              I.params.length !== 0 &&
        ...
        (te.parseClassId = function (n, o) {
          this.type === c.name
            ? ((n.id = this.parseIdent()),
              o && this.checkLValSimple(n.id, Tt, !1))
      ...
      (te.parseExportAllDeclaration = function (n, o) {
        ...
        (te.checkPatternExport = function (n, o) {
          ...
          if (l === 'Identifier') this.checkExport(n, o, o.start);
            ...
            for (var h = 0, m = o.properties; h < m.length; h += 1) {
              var I = m[h];
              this.checkPatternExport(n, I);
            }
          else if (l === 'ArrayPattern')
            for (var R = 0, Y = o.elements; R < Y.length; R += 1) {
              var Q = Y[R];
        ...
        (te.parseImportSpecifier = function () {
          ...
          return (
            ...
            this.checkLValSimple(n.local, Tt),
      ...
      (Nt.toAssignable = function (n, o, l) {
        ...
        (Nt.parseBindingList = function (n, o, l, h) {
          for (var m = [], I = !0; !this.eat(n); )
            if (
              (I ? (I = !1) : this.expect(c.comma), o && this.type === c.comma)
            )
              m.push(null);
            else {
        ...
        (Nt.checkLValPattern = function (n, o, l) {
          switch ((o === void 0 && (o = pt), n.type)) {
            case 'ObjectPattern':
              for (var h = 0, m = n.properties; h < m.length; h += 1) {
                var I = m[h];
                this.checkLValInnerPattern(I, o, l);
              }
              break;
            case 'ArrayPattern':
              for (var R = 0, Y = n.elements; R < Y.length; R += 1) {
                var Q = Y[R];
      ...
      (de.checkPropClash = function (n, o, l) {
        if (
          ...
          if (R) {
            var Y;
            I === 'init'
              ? (Y = (this.strict && R.init) || R.get || R.set)
              : (Y = R.init || R[I]),
              Y && this.raiseRecoverable(h.start, 'Redefinition of property');
          } else R = o[m] = {init: !1, get: !1, set: !1};
          R[I] = !0;
        }
      }),
        (de.parseExpression = function (n, o) {
          ...
          if (this.type === c.comma) {
            var I = this.startNodeAt(l, h);
            for (I.expressions = [m]; this.eat(c.comma); )
              I.expressions.push(this.parseMaybeAssign(n, o));
        ...
        (de.parseMaybeAssign = function (n, o, l) {
          ...
          var ye = this.parseMaybeConditional(n, o);
          if ((l && (ye = l.call(this, ye, Y, Q)), this.type.isAssign)) {
            var xe = this.startNodeAt(Y, Q);
            return (
              (xe.operator = this.value),
              this.type === c.eq && (ye = this.toAssignable(ye, !1, o)),
              h ||
                (o.parenthesizedAssign = o.trailingComma = o.doubleProto = -1),
              o.shorthandAssign >= ye.start && (o.shorthandAssign = -1),
              this.type === c.eq
                ? this.checkLValPattern(ye)
                : this.checkLValSimple(ye),
              (xe.left = ye),
              this.next(),
        ...
        (de.parseMaybeConditional = function (n, o) {
          ...
          if (this.eat(c.question)) {
            ...
            return (
              ...
              this.expect(c.colon),
              (I.alternate = this.parseMaybeAssign(n)),
        ...
        (de.parseExprOp = function (n, o, l, h, m) {
          var I = this.type.binop;
          if (I != null && (!m || this.type !== c._in) && I > h) {
            var R = this.type === c.logicalOR || this.type === c.logicalAND,
              Y = this.type === c.coalesce;
            Y && (I = c.logicalAND.binop);
            var Q = this.value;
            this.next();
            var ye = this.start,
              xe = this.startLoc,
              ...
              Lt = this.buildBinary(o, l, n, Ze, Q, R || Y);
            return (
              ((R && this.type === c.coalesce) ||
                (Y &&
              ...
              this.parseExprOp(Lt, o, l, h, m)
            );
          }
          return n;
        }),
        (de.buildBinary = function (n, o, l, h, m, I) {
          h.type === 'PrivateIdentifier' &&
            this.raise(
              h.start,
              'Private identifier can only be left side of binary expression'
            );
          var R = this.startNodeAt(n, o);
          return (
            (R.left = l),
            (R.operator = m),
            (R.right = h),
            this.finishNode(R, I ? 'LogicalExpression' : 'BinaryExpression')
          );
        }),
        (de.parseMaybeUnary = function (n, o, l, h) {
          var m = this.start,
            I = this.startLoc,
            R;
          if (this.isContextual('await') && this.canAwait)
            (R = this.parseAwait(h)), (o = !0);
            ...
            if (
              ((R = this.parseExprSubscripts(n, h)),
              this.checkExpressionErrors(n))
            )
              return R;
            for (; this.type.postfix && !this.canInsertSemicolon(); ) {
              var ye = this.startNodeAt(m, I);
              (ye.operator = this.value),
                (ye.prefix = !1),
                (ye.argument = R),
                this.checkLValSimple(R),
                this.next(),
                (R = this.finishNode(ye, 'UpdateExpression'));
            }
          }
      ...
      (de.parseExprSubscripts = function (n, o) {
        ...
        if (
          ...
          return m;
        var I = this.parseSubscripts(m, l, h, !1, o);
        return (
          n &&
            I.type === 'MemberExpression' &&
            (n.parenthesizedAssign >= I.start && (n.parenthesizedAssign = -1),
            n.parenthesizedBind >= I.start && (n.parenthesizedBind = -1),
            n.trailingComma >= I.start && (n.trailingComma = -1)),
          I
        );
      }),
        (de.parseSubscripts = function (n, o, l, h, m) {
          for (
            var I =
                this.options.ecmaVersion >= 8 &&
                n.type === 'Identifier' &&
            ...
            var Y = this.parseSubscript(n, o, l, h, I, R, m);
            if (
              (Y.optional && (R = !0),
        ...
        (de.parseSubscriptAsyncArrow = function (n, o, l, h) {
          return this.parseArrowExpression(this.startNodeAt(n, o), l, !0, h);
        }),
        (de.parseSubscript = function (n, o, l, h, m, I, R) {
          ...
          if (
            ...
            if (m && !Q && this.shouldParseAsyncArrow())
              return (
                ...
                this.parseSubscriptAsyncArrow(o, l, gr, R)
              );
        ...
        (de.parseExprAtom = function (n, o, l) {
          ...
          switch (this.type) {
            ...
            case c.name:
              ...
              if (
                ...
                return (
                  ...
                  this.parseFunction(this.startNodeAt(I, R), 0, !1, !0, o)
                );
            ...
            case c.regexp:
              var ye = this.value;
              return (
                (h = this.parseLiteral(ye.value)),
                (h.regex = {pattern: ye.pattern, flags: ye.flags}),
                h
              );
            case c.num:
            case c.string:
        ...
        (de.parseParenAndDistinguishExpression = function (n, o) {
          ...
          if (this.options.ecmaVersion >= 6) {
            ...
            for (this.yieldPos = 0, this.awaitPos = 0; this.type !== c.parenR; )
              if (
                (ye ? (ye = !1) : this.expect(c.comma),
                I && this.afterTrailingComma(c.parenR, !0))
              ) {
                xe = !0;
                break;
        ...
        (de.parseParenArrowList = function (n, o, l, h) {
...
`
        ...
        (de.parseObj = function (n, o) {
          ...
          for (l.properties = [], this.next(); !this.eat(c.braceR); ) {
            if (h) h = !1;
              ...
              break;
            var I = this.parseProperty(n, o);
            n || this.checkPropClash(I, m, o), l.properties.push(I);
          }
        ...
        (de.parseProperty = function (n, o) {
          ...
          this.options.ecmaVersion >= 6 &&
            ((l.method = !1),
            (l.shorthand = !1),
            (n || o) && ((I = this.start), (R = this.startLoc)),
            n || (h = this.eat(c.star)));
          ...
          return (
            ...
            this.isAsyncProp(l)
              ? ((m = !0),
                ...
                this.parsePropertyName(l))
              : (m = !1),
            this.parsePropertyValue(l, n, h, m, I, R, o, Y),
        ...
        (de.parsePropertyValue = function (n, o, l, h, m, I, R, Y) {
        ...
        (de.parseMethod = function (n, o, l) {
          ...
          return (
            ...
            (this.awaitPos = 0),
            (this.awaitIdentPos = 0),
            this.enterScope(ut(o, h.generator) | Ee | (l ? Le : 0)),
            this.expect(c.parenL),
        ...
        (de.parseArrowExpression = function (n, o, l, h) {
          var m = this.yieldPos,
            I = this.awaitPos,
            R = this.awaitIdentPos;
          return (
        ...
        (de.parseFunctionBody = function (n, o, l, h) {
          ...
          if (m)
            ...
            (this.labels = []),
              ...
              this.checkParams(
                n,
                !I && !R && !o && !l && this.isSimpleParamList(n.params)
              ),
              this.strict && n.id && this.checkLValSimple(n.id, Dn),
              (n.body = this.parseBlock(!1, void 0, R && !I)),
              (n.expression = !1),
        ...
        (de.checkParams = function (n, o) {
          for (
            ...
            var I = m[h];
            this.checkLValInnerPattern(I, bt, o ? null : l);
          }
        }),
        (de.parseExprList = function (n, o, l, h) {
          for (var m = [], I = !0; !this.eat(n); ) {
            if (I) I = !1;
            ...
            l && this.type === c.comma
              ...
              ? ((R = this.parseSpread(h)),
                h &&
                  this.type === c.comma &&
                  h.trailingComma < 0 &&
                  (h.trailingComma = this.start))
              : (R = this.parseMaybeAssign(!1, h)),
              m.push(R);
          }
          return m;
        }),
      ...
      (rn.enterScope = function (n) {
        ...
        (rn.treatFunctionsAsVarInScope = function (n) {
          return n.flags & J || (!this.inModule && n.flags & W);
        }),
        (rn.declareName = function (n, o, l) {
          ...
          if (o === Tt) {
            ...
            (h =
              ...
              m.var.indexOf(n) > -1),
              m.lexical.push(n),
              this.inModule && m.flags & W && delete this.undefinedExports[n];
          } else if (o === bn) {
            ...
            this.treatFunctionsAsVar
              ? (h = R.lexical.indexOf(n) > -1)
              : (h = R.lexical.indexOf(n) > -1 || R.var.indexOf(n) > -1),
              R.functions.push(n);
          } else
            for (var Y = this.scopeStack.length - 1; Y >= 0; --Y) {
              ...
              if (
                (Q.var.push(n),
                this.inModule && Q.flags & W && delete this.undefinedExports[n],
                Q.flags & Ke)
              )
                break;
            }
      ...
      var Fn = function (o, l, h) {
          (this.type = ''),
            (this.start = l),
            (this.end = 0),
            o.options.locations && (this.loc = new wt(o, h)),
      ...
      (Bn.finishNode = function (n, o) {
        ...
        (Bn.finishNodeAt = function (n, o, l, h) {
          return Fs.call(this, n, o, l, h);
        }),
      ...
      for (var Ni = 0, Tr = [9, 10, 11, 12, 13, 14]; Ni < Tr.length; Ni += 1) {
        var Ko = Tr[Ni];
        qo(Ko);
      }
      var le = Ge.prototype,
      ...
      (on.prototype.reset = function (o, l, h) {
        var m = h.indexOf('v') !== -1,
          I = h.indexOf('u') !== -1;
        (this.start = o | 0),
          (this.source = l + ''),
        ...
        (on.prototype.at = function (o, l) {
          ...
          var h = this.source,
            m = h.length;
          if (o >= m) return -1;
          var I = h.charCodeAt(o);
          if (!(l || this.switchU) || I <= 55295 || I >= 57344 || o + 1 >= m)
            return I;
          var R = h.charCodeAt(o + 1);
          return R >= 56320 && R <= 57343 ? (I << 10) + R - 56613888 : I;
        }),
        ...
        (on.prototype.eatChars = function (o, l) {
          l === void 0 && (l = !1);
          for (var h = this.pos, m = 0, I = o; m < I.length; m += 1) {
            var R = I[m],
              Y = this.at(h, l);
            if (Y === -1 || Y !== R) return !1;
        ...
        (le.validateRegExpFlags = function (n) {
          for (
            var o = n.validFlags, l = n.flags, h = !1, m = !1, I = 0;
            I < l.length;
            I++
          ) {
            var R = l.charAt(I);
            ...
            if (n.eat(63)) {
              if (this.options.ecmaVersion >= 16) {
                ...
                if (l || h) {
                  ...
                  if (h) {
                    var R = this.regexp_eatModifiers(n);
                    !l &&
                      !R &&
                      n.current() === 58 &&
                    ...
                    for (var Y = 0; Y < R.length; Y++) {
                      var Q = R.charAt(Y);
                      (R.indexOf(Q, Y + 1) > -1 || l.indexOf(Q) > -1) &&
                        n.raise('Duplicate regular expression modifiers');
                    }
                  }
                }
      ...
      (le.regexp_eatExtendedAtom = function (n) {
        ...
        (le.regexp_eatSyntaxCharacter = function (n) {
          var o = n.current();
          return yr(o) ? ((n.lastIntValue = o), n.advance(), !0) : !1;
        });
      function yr(n) {
        return (
          n === 36 ||
      ...
      (le.regexp_eatPatternCharacters = function (n) {
        for (var o = n.pos, l = 0; (l = n.current()) !== -1 && !yr(l); )
          n.advance();
        return n.pos !== o;
      }),
        ...
        (le.regexp_eatRegExpIdentifierStart = function (n) {
          ...
          return (
            ...
            h === 92 &&
              ...
              (h = n.lastIntValue),
            Wo(h) ? ((n.lastIntValue = h), !0) : ((n.pos = o), !1)
          );
        });
      function Wo(n) {
      ...
      le.regexp_eatRegExpIdentifierPart = function (n) {
        ...
        return (
          ...
          h === 92 &&
            this.regexp_eatRegExpUnicodeEscapeSequence(n, l) &&
            (h = n.lastIntValue),
          Go(h) ? ((n.lastIntValue = h), !0) : ((n.pos = o), !1)
        );
      };
      function Go(n) {
        return x(n, !0) || n === 36 || n === 95 || n === 8204 || n === 8205;
      }
          ...
          if (this.regexp_eatFixedHexDigits(n, 4)) {
            ...
            if (h && m >= 55296 && m <= 56319) {
              ...
              if (
                ...
                if (R >= 56320 && R <= 57343)
                  return (
                    (n.lastIntValue = (m - 55296) * 1024 + (R - 56320) + 65536),
                    !0
                  );
              }
              (n.pos = I), (n.lastIntValue = m);
            }
            return !0;
          }
          if (
      ...
      le.regexp_eatCharacterClassEscape = function (n) {
        var o = n.current();
        if (kf(o)) return (n.lastIntValue = -1), n.advance(), Vn;
        var l = !1;
        if (
          n.switchU &&
          this.options.ecmaVersion >= 9 &&
          ...
          if (
            ...
            return l && h === an && n.raise('Invalid property name'), h;
      ...
      (le.regexp_eatUnicodePropertyValueExpression = function (n) {
        ...
        if (this.regexp_eatUnicodePropertyName(n) && n.eat(61)) {
          ...
          if (this.regexp_eatUnicodePropertyValue(n)) {
            ...
            return this.regexp_validateUnicodePropertyNameAndValue(n, l, h), Vn;
          }
        }
        ...
        (le.regexp_eatUnicodePropertyName = function (n) {
          var o = 0;
          for (n.lastStringValue = ''; Rc((o = n.current())); )
      ...
      le.regexp_eatUnicodePropertyValue = function (n) {
        var o = 0;
        for (n.lastStringValue = ''; vf((o = n.current())); )
          (n.lastStringValue += nt(o)), n.advance();
        return n.lastStringValue !== '';
      };
      function vf(n) {
      ...
      (le.regexp_eatLoneUnicodePropertyNameOrValue = function (n) {
        ...
        (le.regexp_eatClassAtom = function (n) {
          ...
          if (n.eat(92)) {
            ...
            if (n.switchU) {
              var l = n.current();
              (l === 99 || Dc(l)) && n.raise('Invalid class escape'),
                n.raise('Invalid escape');
            }
            n.pos = o;
          }
        ...
        (le.regexp_eatClassSetCharacter = function (n) {
          ...
          if (n.eat(92))
            return this.regexp_eatCharacterEscape(n) ||
              ...
              : ((n.pos = o), !1);
          var l = n.current();
          return l < 0 || (l === n.lookahead() && xf(l)) || gf(l)
            ? !1
      ...
      le.regexp_eatClassSetReservedPunctuator = function (n) {
        var o = n.current();
        return _f(o) ? ((n.lastIntValue = o), n.advance(), !0) : !1;
      };
      function _f(n) {
        return (
          n === 33 ||
      ...
      le.regexp_eatHexDigits = function (n) {
        var o = n.pos,
          l = 0;
        for (n.lastIntValue = 0; Lc((l = n.current())); )
          (n.lastIntValue = 16 * n.lastIntValue + Oc(l)), n.advance();
        return n.pos !== o;
      };
      function Lc(n) {
        return (
      ...
      le.regexp_eatFixedHexDigits = function (n, o) {
        ...
        for (var h = 0; h < o; ++h) {
          var m = n.current();
          if (!Lc(m)) return (n.pos = l), !1;
          (n.lastIntValue = 16 * n.lastIntValue + Oc(m)), n.advance();
        }
        return !0;
      };
      var xr = function (o) {
      ...
      (Ae.next = function (n) {
        ...
        (Ae.readRegexp = function () {
          for (var n, o, l = this.pos; ; ) {
            ...
            if (
              (M.test(h) && this.raise(l, 'Unterminated regular expression'), n)
            )
              n = !1;
            else {
              if (h === '[') o = !0;
          ...
          return this.finishToken(c.regexp, {pattern: m, flags: R, value: Q});
        }),
        (Ae.readInt = function (n, o, l) {
          ...
          return (
            ...
            this.pos === I || (o != null && this.pos - I !== o) ? null : R
          );
        });
      function bf(n, o) {
      ...
      (Ae.readRadixNumber = function (n) {
        ...
        return (
          ...
          this.input.charCodeAt(this.pos) === 110
            ? ((l = Mc(this.input.slice(o, this.pos))), ++this.pos)
        ...
        (Ae.readNumber = function (n) {
          ...
          if (!l && !n && this.options.ecmaVersion >= 11 && h === 110) {
            var m = Mc(this.input.slice(o, this.pos));
            return (
              ++this.pos,
              f(this.fullCharCodeAtPos()) &&
                this.raise(this.pos, 'Identifier directly after number'),
          ...
          l && /[89]/.test(this.input.slice(o, this.pos)) && (l = !1),
            ...
            f(this.fullCharCodeAtPos()) &&
              this.raise(this.pos, 'Identifier directly after number');
          var I = bf(this.input.slice(o, this.pos), l);
      ...
      (Ae.tryReadTemplateToken = function () {
        ...
        try {
          ...
          if (n === Fc) this.readInvalidTemplateToken();
          else throw n;
        }
        this.inTemplateElement = !1;
      }),
        (Ae.invalidStringToken = function (n, o) {
          if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw Fc;
          this.raise(n, o);
        }),
...
`;
        ...
        (Ae.readWord = function () {
          var n = this.readWord1(),
            o = c.name;
          return this.keywords.test(n) && (o = H[n]), this.finishToken(o, n);
        });
      var Bc = '8.15.0';
      Ge.acorn = {
        Parser: Ge,
  ...
  var ff = Z((Bo, hf) => {
    (function (e, t) {
      ...
      var a = function (f, x) {
        if (
          (x === void 0 && (x = {}),
          (this.toks = this.constructor.BaseParser.tokenizer(f, x)),
          ...
          var g = this.toks.curPosition();
          this.tok.loc = new t.SourceLocation(this.toks, g, g);
        }
        (this.ahead = []),
          (this.context = []),
          (this.curIndent = 0),
      ...
      (a.prototype.startNode = function () {
        ...
        (a.prototype.finishNode = function (f, x) {
          return (
            (f.type = x),
            (f.end = this.last.end),
        ...
        (a.prototype.dummyNode = function (f) {
          ...
          return (
            (x.type = f),
            (x.end = x.start),
            this.options.locations && (x.loc.end = x.loc.start),
            this.options.ranges && (x.range[1] = x.start),
            (this.last = {
        ...
        (a.prototype.expect = function (f) {
          ...
          for (var x = 1; x <= 2; x++)
            if (this.lookAhead(x).type === f) {
              for (var g = 0; g < x; g++) this.next();
              return !0;
            }
        }),
        ...
        (a.prototype.indentationAfter = function (f) {
          for (var x = 0; ; ++f) {
            var g = this.input.charCodeAt(f);
            if (g === 32) ++x;
            else if (g === 9) x += this.options.tabSize;
            else return x;
          }
        }),
        (a.prototype.closes = function (f, x, g, S) {
        ...
        (a.extend = function () {
          for (var f = [], x = arguments.length; x--; ) f[x] = arguments[x];
          for (var g = this, S = 0; S < f.length; S++) g = f[S](g);
          return g;
        }),
        (a.parse = function (f, x) {
          return new this(f, x).parse();
        }),
      ...
      (p.next = function () {
          ...
          for (;;)
            try {
              ...
              if (/unterminated/i.test(u))
                if (((f = this.lineEnd(E.pos + 1)), /string/.test(u)))
                  x = {
                    start: E.pos,
                    end: f,
                    type: t.tokTypes.string,
                    value: this.input.slice(E.pos + 1, f),
                  };
                else if (/regular expr/i.test(u)) {
                  var g = this.input.slice(E.pos, f);
                  try {
                    g = new RegExp(g);
                  } catch {}
                  x = {start: E.pos, end: f, type: t.tokTypes.regexp, value: g};
                } else
                  /template/.test(u)
                    ? (x = {
                        start: E.pos,
                        ...
                        value: this.input.slice(E.pos, f),
                      })
                    : (x = !1);
              else if (
                ...
                for (; f < this.input.length; ) {
                  var S = this.input.charCodeAt(f++);
                  if (S === 34 || S === 39 || t.isNewLine(S)) break;
                }
              else if (/unexpected character/i.test(u)) f++, (x = !1);
              else if (/regular expression/i.test(u)) x = !0;
              else throw E;
              if (
                (this.resetTo(f),
                x === !0 &&
                  (x = {start: f, end: f, type: t.tokTypes.name, value: s}),
                x)
              )
                return (
                  this.options.locations &&
                    (x.loc = new t.SourceLocation(
                      this.toks,
                      t.getLineInfo(this.input, x.start),
                      t.getLineInfo(this.input, x.end)
                    )),
                  x
                );
            }
        ...
        (p.resetTo = function (u) {
          ...
          if (
            ...
            for (var x; (x = t.lineBreakG.exec(this.input)) && x.index < u; )
              ++this.toks.curLine,
                (this.toks.lineStart = x.index + x[0].length);
          }
        }),
      ...
      (y.parseTopLevel = function () {
        ...
        (y.parseStatement = function () {
          var u = this.tok.type,
            ...
            x;
          switch (
            (this.toks.isLet() && ((u = t.tokTypes._var), (x = 'let')), u)
          ) {
            case t.tokTypes._break:
            case t.tokTypes._continue:
              this.next();
              var g = u === t.tokTypes._break;
              return (
                this.semicolon() || this.canInsertSemicolon()
                  ...
                  : ((f.label =
                      this.tok.type === t.tokTypes.name
                        ...
                        : null),
                    this.semicolon()),
                this.finishNode(f, g ? 'BreakStatement' : 'ContinueStatement')
              );
            ...
            case t.tokTypes._for:
              ...
              var E = this.toks.isLet(),
                L = this.toks.isAwaitUsing(!0),
                H = !L && this.toks.isUsing(!0);
              if (
                E ||
                ...
                return (
                  H || L
                    ? (L && this.next(), this.parseVar(c, !0, D))
                    : (c = this.parseVar(c, !0, D)),
              ...
              return this.tok.type === t.tokTypes._in || this.isContextual('of')
                ? (this.options.ecmaVersion >= 9 &&
                    this.tok.type !== t.tokTypes._in &&
                    (f.await = S),
                  this.parseForIn(f, this.toAssignable(M)))
                : this.parseFor(f, M);
            ...
            case t.tokTypes._switch:
              ...
              for (var ie; !this.closes(t.tokTypes.braceR, z, X, !0); )
                if (
            ...
            case t.tokTypes._const:
              return this.parseVar(f, !1, x || this.tok.value);
        ...
        (y.parseBlock = function () {
          ...
          var f = this.curIndent,
            x = this.curLineStart;
          for (u.body = []; !this.closes(t.tokTypes.braceR, f, x, !0); )
            u.body.push(this.parseStatement());
          return (
            this.popCx(),
            this.eat(t.tokTypes.braceR),
        ...
        (y.parseVar = function (u, f, x) {
          (u.kind = x), this.next(), (u.declarations = []);
          do {
          ...
          if (!u.declarations.length) {
            ...
            (S.id = this.dummyIdent()),
              u.declarations.push(this.finishNode(S, 'VariableDeclarator'));
          }
          return (
            f || this.semicolon(), this.finishNode(u, 'VariableDeclaration')
          );
        }),
        (y.parseClass = function (u) {
          ...
          this.next(),
            ...
            (f.body.body = []),
            this.pushCx();
          var x = this.curIndent + 1,
            g = this.curLineStart;
          for (
            this.eat(t.tokTypes.braceL),
              this.curIndent + 1 < x &&
                ((x = this.curIndent), (g = this.curLineStart));
            !this.closes(t.tokTypes.braceR, x, g);

          ) {
            var S = this.parseClassElement();
            S && f.body.body.push(S);
          }
          return (
            this.popCx(),
            this.eat(t.tokTypes.braceR) ||
            ...
            this.finishNode(f, u ? 'ClassDeclaration' : 'ClassExpression')
          );
        }),
        (y.parseClassElement = function () {
          ...
          if (
            ...
            H = this.eat(t.tokTypes.star);
            var z = this.toks.value;
            (this.eatContextual('get') || this.eatContextual('set')) &&
              (this.isClassElementNameStart() ? (c = z) : (L = z));
          }
          if (L)
            (E.computed = !1),
              (E.key = this.startNodeAt(
                x
          ...
          else if ((this.parseClassElementName(E), i(E.key)))
            return (
          ...
          if (
            ...
            var X =
              ...
              !D &&
              c === 'method' &&
              ((E.key.type === 'Identifier' && E.key.name === 'constructor') ||
                (E.key.type === 'Literal' && E.key.value === 'constructor'));
            (E.kind = X ? 'constructor' : c),
              (E.value = this.parseMethod(H, D)),
        ...
        (y.parseClassStaticBlock = function (u) {
          var f = this.curIndent,
            x = this.curLineStart;
          for (
            u.body = [], this.pushCx();
            !this.closes(t.tokTypes.braceR, f, x, !0);
        ...
        (y.parseFunction = function (u, f, x) {
          ...
          return (
            ...
            this.options.ecmaVersion >= 8 && (u.async = !!x),
            this.tok.type === t.tokTypes.name
              ? (u.id = this.parseIdent())
              : f === !0 && (u.id = this.dummyIdent()),
            ...
            (this.inGenerator = S),
            (this.inFunction = E),
            this.finishNode(u, f ? 'FunctionDeclaration' : 'FunctionExpression')
          );
        }),
        (y.parseExport = function () {
          ...
          if (this.eat(t.tokTypes._default)) {
            ...
            if (
              ...
              this.next(),
                f && this.next(),
                (u.declaration = this.parseFunction(x, 'nullableID', f));
            } else
          ...
          if (this.tok.type === t.tokTypes.star) {
            ...
            this.next(),
              (f.local = this.eatContextual('as')
                ? this.parseIdent()
                : this.dummyIdent()),
              u.push(this.finishNode(f, 'ImportNamespaceSpecifier'));
          } else {
            var x = this.curIndent,
              g = this.curLineStart,
              S = this.nextLineStart;
            for (
              this.pushCx(),
                this.eat(t.tokTypes.braceL),
                this.curLineStart > S && (S = this.curLineStart);
              !this.closes(
                t.tokTypes.braceR,
                x + (this.curLineStart <= S ? 1 : 0),
                g
              );
              ...
              if (this.eat(t.tokTypes.star))
                ...
                if (
                  ...
                  ((E.imported = this.parseModuleExportName()), i(E.imported))
                )
                  break;
                (E.local = this.eatContextual('as')
                  ? this.parseModuleExportName()
              ...
              u.push(E), this.eat(t.tokTypes.comma);
            }
        ...
        (y.parseWithClause = function () {
          ...
          for (
            this.pushCx(),
              this.eat(t.tokTypes.braceL),
              this.curLineStart > g && (g = this.curLineStart);
            !this.closes(
              t.tokTypes.braceR,
              f + (this.curLineStart <= g ? 1 : 0),
              x
            );
            ...
            if (
              ...
              this.tok.type === t.tokTypes.string
                ? (S.value = this.parseExprAtom())
                : (S.value = this.dummyString());
            else {
              if (i(S.key)) break;
            ...
            u.push(this.finishNode(S, 'ImportAttribute')),
              this.eat(t.tokTypes.comma);
          }
        ...
        (y.parseExportSpecifierList = function () {
          ...
          for (
            ...
            var S = this.startNode();
            if (((S.local = this.parseModuleExportName()), i(S.local))) break;
      ...
      (k.checkLVal = function (u) {
        ...
        (k.parseExpression = function (u) {
          var f = this.storeCurrentPos(),
            x = this.parseMaybeAssign(u);
          if (this.tok.type === t.tokTypes.comma) {
            var g = this.startNodeAt(f);
            for (g.expressions = [x]; this.eat(t.tokTypes.comma); )
              g.expressions.push(this.parseMaybeAssign(u));
        ...
        (k.parseMaybeAssign = function (u) {
          ...
          var x = this.storeCurrentPos(),
            g = this.parseMaybeConditional(u);
          if (this.tok.type.isAssign) {
            var S = this.startNodeAt(x);
            return (
              (S.operator = this.tok.value),
              (S.left =
                this.tok.type === t.tokTypes.eq
                  ? this.toAssignable(g)
                  : this.checkLVal(g)),
              this.next(),
              (S.right = this.parseMaybeAssign(u)),
              this.finishNode(S, 'AssignmentExpression')
            );
          }
          return g;
        }),
        (k.parseMaybeConditional = function (u) {
          var f = this.storeCurrentPos(),
            x = this.parseExprOps(u);
          if (this.eat(t.tokTypes.question)) {
            var g = this.startNodeAt(f);
            return (
              (g.test = x),
              (g.consequent = this.parseMaybeAssign()),
              (g.alternate = this.expect(t.tokTypes.colon)
                ? this.parseMaybeAssign(u)
                : this.dummyIdent()),
              this.finishNode(g, 'ConditionalExpression')
            );
          }
          return x;
        }),
        (k.parseExprOps = function (u) {
          var f = this.storeCurrentPos(),
            x = this.curIndent,
            g = this.curLineStart;
          return this.parseExprOp(this.parseMaybeUnary(!1), f, -1, u, x, g);
        }),
        (k.parseExprOp = function (u, f, x, g, S, E) {
          if (
            this.curLineStart !== E &&
            this.curIndent < S &&
            this.tokenStartsLine()
            ...
            return u;
          var L = this.tok.type.binop;
          if (L != null && (!g || this.tok.type !== t.tokTypes._in) && L > x) {
            var H = this.startNodeAt(f);
            if (
              ((H.left = u),
              ...
              var D = this.storeCurrentPos();
              H.right = this.parseExprOp(
            ...
            return (
              ...
              this.parseExprOp(H, f, x, g, S, E)
            );
          }
          return u;
        }),
        (k.parseMaybeUnary = function (u) {
          var f = this.storeCurrentPos(),
            x;
          if (
            this.options.ecmaVersion >= 8 &&
            ...
            (x = this.parseAwait()), (u = !0);
          else if (this.tok.type.prefix) {
            var g = this.startNode(),
              S = this.tok.type === t.tokTypes.incDec;
            S || (u = !0),
              (g.operator = this.tok.value),
              (g.prefix = !0),
              this.next(),
              (g.argument = this.parseMaybeUnary(!0)),
              S && (g.argument = this.checkLVal(g.argument)),
              (x = this.finishNode(
                g,
            ...
            var E = this.startNode();
            this.next(),
              (E.argument = this.parseMaybeUnary(u)),
              (x = this.finishNode(E, 'SpreadElement'));
          } else if (!u && this.tok.type === t.tokTypes.privateId)
            x = this.parsePrivateIdent();
          else
            for (
              x = this.parseExprSubscripts();
              this.tok.type.postfix && !this.canInsertSemicolon();

            ) {
              var L = this.startNodeAt(f);
              (L.operator = this.tok.value),
                (L.prefix = !1),
                (L.argument = this.checkLVal(x)),
                this.next(),
                (x = this.finishNode(L, 'UpdateExpression'));
            }
        ...
        (k.parseExprSubscripts = function () {
        ...
        (k.parseSubscripts = function (u, f, x, g, S) {
          for (var E = this.options.ecmaVersion >= 11, L = !1; ; ) {
            if (
              this.curLineStart !== S &&
              this.curIndent <= g &&
              this.tokenStartsLine()
            )
              if (this.tok.type === t.tokTypes.dot && this.curIndent === g) --g;
              else break;
            var H =
                u.type === 'Identifier' &&
                u.name === 'async' &&
                !this.canInsertSemicolon(),
              D = E && this.eat(t.tokTypes.questionDot);
            if (
              (D && (L = !0),
              (D &&
              ...
              var M = this.startNodeAt(f);
              (M.object = u),
                (M.property = this.parseExpression()),
                (M.computed = !0),
                E && (M.optional = D),
                this.popCx(),
                this.expect(t.tokTypes.bracketR),
                (u = this.finishNode(M, 'MemberExpression'));
            } else if (!x && this.tok.type === t.tokTypes.parenL) {
              var z = this.parseExprList(t.tokTypes.parenR);
              if (H && this.eat(t.tokTypes.arrow))
                return this.parseArrowExpression(this.startNodeAt(f), z, !0);
        ...
        (k.parseExprAtom = function () {
          ...
          switch (this.tok.type) {
            ...
            case t.tokTypes._super:
              ...
              return (u = this.startNode()), this.next(), this.finishNode(u, f);
            case t.tokTypes.name:
              var x = this.storeCurrentPos(),
                g = this.parseIdent(),
                S = !1;
              if (g.name === 'async' && !this.canInsertSemicolon()) {
                if (this.eat(t.tokTypes._function))
                  return (
                    this.toks.overrideContext(t.tokContexts.f_expr),
                    this.parseFunction(this.startNodeAt(x), !1, !0)
                  );
                this.tok.type === t.tokTypes.name &&
                  ((g = this.parseIdent()), (S = !0));
              }
              return this.eat(t.tokTypes.arrow)
                ? this.parseArrowExpression(this.startNodeAt(x), [g], S)
                : g;
            case t.tokTypes.regexp:
              u = this.startNode();
              var E = this.tok.value;
              return (
                (u.regex = {pattern: E.pattern, flags: E.flags}),
                (u.value = E.value),
            ...
            case t.tokTypes.parenL:
              ...
              if (
                ...
                var D = H.expressions || [H];
                return (
                  D.length && i(D[D.length - 1]) && D.pop(),
                  this.parseArrowExpression(this.startNodeAt(L), D)
                );
              }
              if (this.options.preserveParens) {
                var c = this.startNodeAt(L);
                (c.expression = H),
                  (H = this.finishNode(c, 'ParenthesizedExpression'));
              }
              return H;
        ...
        (k.parseExprImport = function () {
          ...
          switch (this.tok.type) {
            ...
            case t.tokTypes.dot:
              return (u.meta = f), this.parseImportMeta(u);
            default:
              return (u.name = 'import'), this.finishNode(u, 'Identifier');
          }
        }),
        (k.parseDynamicImport = function (u) {
          var f = this.parseExprList(t.tokTypes.parenR);
          return (
            (u.source = f[0] || this.dummyString()),
            (u.options = f[1] || null),
            this.finishNode(u, 'ImportExpression')
          );
        }),
        (k.parseImportMeta = function (u) {
          return (
            this.next(),
...
`
        ...
        (k.parseObj = function () {
          ...
          for (
            this.eat(t.tokTypes.braceL),
              this.curIndent + 1 < f &&
                ((f = this.curIndent), (x = this.curLineStart));
            !this.closes(t.tokTypes.braceR, f, x);
            ...
            if (
              ...
              (g.argument = this.parseMaybeAssign()),
                u.properties.push(this.finishNode(g, 'SpreadElement')),
                this.eat(t.tokTypes.comma);
              continue;
            }
            if (
              (this.options.ecmaVersion >= 6 &&
                ((L = this.storeCurrentPos()),
                (g.method = !1),
                (g.shorthand = !1),
                (S = this.eat(t.tokTypes.star))),
              this.parsePropertyName(g),
              this.toks.isAsyncProp(g)
                ? ((E = !0),
                  (S =
            ...
            if (this.eat(t.tokTypes.colon))
              (g.kind = 'init'), (g.value = this.parseMaybeAssign());
            else if (
              this.options.ecmaVersion >= 6 &&
              (this.tok.type === t.tokTypes.parenL ||
              ...
              (g.kind = 'init'),
                (g.method = !0),
                (g.value = this.parseMethod(S, E));
            else if (
              this.options.ecmaVersion >= 5 &&
              g.key.type === 'Identifier' &&
              !g.computed &&
              (g.key.name === 'get' || g.key.name === 'set') &&
              ...
              (g.kind = g.key.name),
                this.parsePropertyName(g),
                (g.value = this.parseMethod(!1));
            else {
              if (((g.kind = 'init'), this.options.ecmaVersion >= 6))
                if (this.eat(t.tokTypes.eq)) {
                  var H = this.startNodeAt(L);
                  (H.operator = '='),
                    (H.left = g.key),
                    (H.right = this.parseMaybeAssign()),
                    (g.value = this.finishNode(H, 'AssignmentExpression'));
                } else g.value = g.key;
              else g.value = this.dummyIdent();
              g.shorthand = !0;
            }
            u.properties.push(this.finishNode(g, 'Property')),
              this.eat(t.tokTypes.comma);
          }
          return (
            this.popCx(),
        ...
        (k.parsePropertyName = function (u) {
          if (this.options.ecmaVersion >= 6)
        ...
        (k.parseIdent = function () {
          ...
          var f = this.startNode();
          return this.next(), (f.name = u), this.finishNode(f, 'Identifier');
        }),
        ...
        (k.toAssignable = function (u, f) {
          if (
            !(
              !u ||
              u.type === 'Identifier' ||
              (u.type === 'MemberExpression' && !f)
            )
          )
            if (u.type === 'ParenthesizedExpression')
              this.toAssignable(u.expression, f);
            else {
              if (this.options.ecmaVersion < 6) return this.dummyIdent();
              if (u.type === 'ObjectExpression') {
                u.type = 'ObjectPattern';
                for (var x = 0, g = u.properties; x < g.length; x += 1) {
                  var S = g[x];
                  this.toAssignable(S, f);
                }
              } else if (u.type === 'ArrayExpression')
                (u.type = 'ArrayPattern'), this.toAssignableList(u.elements, f);
              else if (u.type === 'Property') this.toAssignable(u.value, f);
              else if (u.type === 'SpreadElement')
                (u.type = 'RestElement'), this.toAssignable(u.argument, f);
        ...
        (k.toAssignableList = function (u, f) {
          for (var x = 0, g = u; x < g.length; x += 1) {
            var S = g[x];
            this.toAssignable(S, f);
          }
          return u;
        }),
        (k.parseFunctionParams = function (u) {
          return (
            (u = this.parseExprList(t.tokTypes.parenR)),
            this.toAssignableList(u, !0)
          );
        }),
        (k.parseMethod = function (u, f) {
          var x = this.startNode(),
            g = this.inAsync,
            S = this.inGenerator,
            E = this.inFunction;
          return (
            this.initFunction(x),
            this.options.ecmaVersion >= 6 && (x.generator = !!u),
            this.options.ecmaVersion >= 8 && (x.async = !!f),
            (this.inAsync = x.async),
            (this.inGenerator = x.generator),
            (this.inFunction = !0),
            (x.params = this.parseFunctionParams()),
            (x.body = this.parseBlock()),
            this.toks.adaptDirectivePrologue(x.body.body),
            (this.inAsync = g),
            (this.inGenerator = S),
            (this.inFunction = E),
        ...
        (k.parseArrowExpression = function (u, f, x) {
          var g = this.inAsync,
            S = this.inGenerator,
            E = this.inFunction;
          return (
            ...
            (this.inGenerator = !1),
            (this.inFunction = !0),
            (u.params = this.toAssignableList(f, !0)),
        ...
        (k.parseExprList = function (u, f) {
          this.pushCx();
          var x = this.curIndent,
            g = this.curLineStart,
            S = [];
          for (this.next(); !this.closes(u, x + 1, g); ) {
            if (this.eat(t.tokTypes.comma)) {
              S.push(f ? null : this.dummyIdent());
              continue;
            }
            var E = this.parseMaybeAssign();
            if (i(E)) {
              if (this.closes(u, x, g)) break;
              this.next();
            } else S.push(E);
            this.eat(t.tokTypes.comma);
          }
      ...
      (e.LooseParser = a), (e.isDummy = i), (e.parse = A);
    });
  });
  var Vo = Li(),
    qg = Yc(),
  ...
  function Wg(e) {
    if (e.indexOf('use client') === -1 && e.indexOf('use server') === -1)
      return null;
    try {
      var t = Ug.parse(e, {ecmaVersion: '2024', sourceType: 'source'}).body;
    } catch {
      return null;
    }
  ...
  function zg(e) {
    var t = {react: Vo, 'react/jsx-runtime': qg},
      s = {},
      i = null;
    if (
      (Object.keys(e).forEach(function (k) {
        if (!i)
          try {
            s[k] = Kg.transform(e[k], {
              transforms: ['jsx', 'imports'],
              jsxRuntime: 'automatic',
              production: !0,
            }).code;
          } catch (A) {
            i = k + ': ' + (A.message || String(A));
          }
      }),
      i)
    )
    ...
    function r(k, A) {
      ...
      if (A.startsWith('.')) {
        var u = Gg(k, A);
        if (t[u] || s[u]) return u;
        for (var f = ['.js', '.jsx', '.ts', '.tsx'], x = 0; x < f.length; x++) {
          var g = u + f[x];
          if (t[g] || s[g]) return g;
        }
      }
    ...
    function d(k) {
      if (t[k]) return t[k];
      if (!s[k]) throw new Error('Module "' + k + '" not found');
      if (a[k]) return a[k].exports;
      var A = Wg(e[k]);
      if (A === 'use client')
        return (t[k] = dr.createClientModuleProxy(k)), (p[k] = !0), t[k];
      var u = {exports: {}};
      a[k] = u;
      var f = function (E) {
        if (E.endsWith('.css')) return {};
        var L = r(k, E);
        return t[L] ? t[L] : d(L);
      };
      if (
        (new Function('module', 'exports', 'require', 'React', s[k])(
          u,
          u.exports,
          f,
          Vo
        ...
        for (var x = Object.keys(u.exports), g = 0; g < x.length; g++) {
          var S = x[g];
          typeof u.exports[S] == 'function' && Hg(u.exports[S], k, S);
        }
      return delete a[k], u.exports;
    }
    var y = {exports: {}};
    return (
      Object.keys(s).forEach(function (k) {
        d(k),
          (k === '/src/App.js' || k === './App.js' || k === './src/App.js') &&
            (y.exports = t[k]);
      }),
      (Os = {module: y.exports}),
      {type: 'deployed', compiledClients: s, clientEntries: p}
    );
  }
  function Xg() {
    ...
    return dr.renderToReadableStream(t, mf(), {onError: console.error});
  }
  function Yg(e, t) {
    if (!Os) throw new Error('No code deployed');
    var s = Tf[e];
  ...
  self.onmessage = function (e) {
    ...
    if (t.type === 'deploy')
      ...
      try {
        Yg(t.actionId, t.encodedArgs).then(function (r) {
          df(t.requestId, r);
        });
      } catch (r) {
        self.postMessage({
