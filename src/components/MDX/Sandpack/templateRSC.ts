...
// @ts-expect-error — text module imports (requires experimental.textModuleImports)
import webpackShim from './sandpack-rsc/sandbox-code/src/webpack-shim.js' with {type: 'text'};
// @ts-expect-error — text module import
import rscClient from './sandpack-rsc/sandbox-code/src/rsc-client.js' with {type: 'text'};
// @ts-expect-error — text module import
import reactRefreshInit from './sandpack-rsc/sandbox-code/src/__react_refresh_init__.js' with {type: 'text'};
// @ts-expect-error — text module import
import workerBundle from './sandpack-rsc/sandbox-code/src/worker-bundle.dist.js' with {type: 'text'};
// @ts-expect-error — text module import
import rsdwClient from '../../../../node_modules/react-server-dom-webpack/cjs/react-server-dom-webpack-client.browser.production.js' with {type: 'text'};
// @ts-expect-error — text module import
import reactRefreshRuntime from '../../../../node_modules/next/dist/compiled/react-refresh/cjs/react-refresh-runtime.development.js' with {type: 'text'};
...
// --- RSC infrastructure files (generated by scripts/buildRscWorker.mjs) ---
const RSC_SOURCE_FILES = {
  'webpack-shim': webpackShim,
  'rsc-client': rscClient,
  'react-refresh-init': reactRefreshInit,
  'worker-bundle': `export default ${JSON.stringify(workerBundle)};`,
  'rsdw-client': rsdwClient,
};

// Strip the `if (process.env.NODE_ENV !== "production")` guard so the
// runtime always executes inside the sandbox.
const reactRefreshRaw = reactRefreshRuntime;
