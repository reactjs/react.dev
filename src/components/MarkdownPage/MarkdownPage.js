  ...
  return (
    <Flex
      ...
      css={{
        ...
        zIndex: 0,
        '& h1, & h2, & h3, & h4, & h5, & h6': {
          scrollMarginTop: 'calc(var(--survey-banner-height-normal) + var(--social-banner-height-normal))',
          [media.lessThan('small')]: {
            scrollMarginTop: 'calc(var(--survey-banner-height-small) + var(--social-banner-height-small))',
          },
        },
      }}>
      <TitleAndMetaTags
