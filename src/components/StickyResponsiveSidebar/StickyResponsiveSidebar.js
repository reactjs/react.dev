...
class StickyResponsiveSidebar extends Component<Props, State> {
  ...
  render() {
    ...
    const smallScreenSidebarStyles = {
      top: 'calc(var(--survey-banner-height-small) + var(--social-banner-height-small))',
      left: 0,
      bottom: 0,
      right: 0,
      position: 'fixed',
          ...
          <div
            ...
            css={{
              ...
              [media.between('small', 'medium')]: {
                marginTop: 'calc(20px + var(--survey-banner-height-normal) + var(--social-banner-height-normal))',
              },

              [media.between('medium', 'large')]: {
                marginTop: 'calc(50px + var(--survey-banner-height-normal) + var(--social-banner-height-normal))',
              },
