...
The best way to get your bug fixed is to provide a reduced test case. This [JSFiddle](https://jsfiddle.net/Luktwrdm/) template is a great starting point.

### Security Bugs {/*security-bugs*/}
Facebook has a [bounty program](https://web.facebook.com/whitehat/) for the safe disclosure of security bugs. With that in mind, please do not file public issues; go through the process outlined on that page.
...
9. Run the [Flow](https://flow.org/) typechecks (`yarn flow`).
...
* You have [Node](https://nodejs.org/en) installed at LTS and [Yarn](https://yarnpkg.com/en/) at v1.2.0+.
