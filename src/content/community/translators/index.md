...
title="프론트엔드 개발자"
  name="유은미"
  translated={[{"title":"Lifecycle of Reactive Effects","translatedTitle":"반응형 Effect의 생명주기","url":"/learn/lifecycle-of-reactive-effects"},{"title":"Reusing Logic with Custom Hooks","translatedTitle":"커스텀 훅으로 로직 재사용하기","url":"/learn/reusing-logic-with-custom-hooks"},{"title":"Separating Events from Effects","translatedTitle":"이벤트와 Effect 분리하기","url":"/learn/separating-events-from-effects"},{"title":"State as a Snapshot","translatedTitle":"스냅샷으로서의 state","url":"/learn/state-as-a-snapshot"},{"title":"Built-in React Hooks","url":"/reference/react/index"},{"title":"<textarea>","url":"/reference/react-dom/components/textarea"}]}
>
