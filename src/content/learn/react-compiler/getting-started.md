...
React Compiler is designed to work out of the box without configuration. However, if you need to configure it (for example, to target React versions below 19), refer to the [compiler options reference](/reference/react/react-compiler).
