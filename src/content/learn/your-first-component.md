...
export default function Profile() {
  return (
    <img
      src="https://react.dev/images/content/creola-katherine-johnson-m.jpg"
...
```js
return <img src="https://react.dev/images/content/creola-katherine-johnson-s.jpg" alt="Katherine Johnson" />;
```
...
return (
  <div>
    <img src="https://react.dev/images/content/creola-katherine-johnson-s.jpg" alt="Katherine Johnson" />
  </div>
);
```
...
function Profile() {
  return (
    <img
      src="https://react.dev/images/content/aklilu-lemma.jpg"
      alt="Aklilu Lemma"
    />
  );
}
...
export default function Profile() {
  return
    <img src="https://react.dev/images/content/katsuko-saruhashi-m.jpg" alt="Katsuko Saruhashi" />;
}
```
...
```js
export default function Profile() {
  return <img src="https://react.dev/images/content/katsuko-saruhashi-m.jpg" alt="Katsuko Saruhashi" />;
}
```
...
export default function Profile() {
  return (
    <img 
      src="https://react.dev/images/content/katsuko-saruhashi-m.jpg" 
