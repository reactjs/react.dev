...
By default, React will log all uncaught errors caught to the console. To implement your own error reporting, you can provide the optional `onUncaughtError` root option:
...
1. The <CodeStep step={2}>error</CodeStep> that was caught.
...
<!--
  ...
  was generated from App by react-dom/server.
-->
<div id="root"><span>This error show the error dialog:</span><button>Throw error</button></div>
</body>
</html>
```
...
export default function App() {
  ...
  return (
    <>
      ...
      >
        <span>This error show the error dialog:</span>
...
1. The <CodeStep step={2}>error</CodeStep> that was caught. Some errors may include the original cause as <CodeStep step={3}>error.cause</CodeStep>.
